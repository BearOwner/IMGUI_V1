...
// struct FGameModePlayerEquipmentAvatar InEquipmentAvatar              (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// int                            ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

int UBackpackBlueprintUtils_BP_C::GetEquipmentSkinIDByAvatar(int* InItemID, struct FGameModePlayerEquipmentAvatar* InEquipmentAvatar)
{
	...
	if (InEquipmentAvatar != nullptr)
		*InEquipmentAvatar = params.InEquipmentAvatar;
...
int UBackpackBlueprintUtils_BP_C::GetEquipmentArmorLevel(int* ItemId)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
