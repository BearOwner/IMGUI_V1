...
{
public:
	struct FScriptMulticastDelegate                    OnUnitTakeDamage;                                         // 0x05B0(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      bEnableTeamAI : 1;                                        // 0x05C0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00[0x7];                                       // 0x05C1(0x0007) MISSED OFFSET
	TArray<class UClass*>                              TeamAIClasses;                                            // 0x05C8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                SpawnerTeamID;                                            // 0x05D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EBotCategray>                     SpeciesCategory;                                          // 0x05DC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x05DD(0x0003) MISSED OFFSET
	int                                                SpawnerCampItemID;                                        // 0x05E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                GroupID;                                                  // 0x05E4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UActorComponent*>                     TeamAIComponents;                                         // 0x05E8(0x0010) (ExportObject, ZeroConstructor)
...
public:
	...
	struct FMonsterParams                              CacheMobParams;                                           // 0x01E0(0x0058)
	struct FFakePlayerParams                           CacheFPParams;                                            // 0x0238(0x0014)
	struct FAIPlayerParams                             CacheAIPParams;                                           // 0x024C(0x000C)
	struct FVehicleParams                              CacheVehicleParams;                                       // 0x0258(0x0014)
	unsigned char                                      UnknownData02[0x4];                                       // 0x026C(0x0004) MISSED OFFSET
	struct FDecoratorParams                            CacheDecoratorParams;                                     // 0x0270(0x0018)
	TMap<TEnumAsByte<enum EBotCategray>, int>          UnitsNumberThreshold;                                     // 0x0288(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData03[0xF8];                                      // 0x02D8(0x00F8) MISSED OFFSET
...
// 0x0138 (0x0388 - 0x0250)
class UAIBehaviorAdapter_VehicleBase : public UVehicleComponent
{
public:
	float                                              LoseSightRadius;                                          // 0x0250(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              QueryEnemyRange;                                          // 0x0254(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              QueryEnemyAngle;                                          // 0x0258(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MinTimeLockTarget;                                        // 0x025C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxRememberEnemySeconds;                                  // 0x0260(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PreciseHatredDecreaseSpeed;                               // 0x0264(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bCorrectAfterTurnOver : 1;                                // 0x0268(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0269(0x0003) MISSED OFFSET
	float                                              CorrectAfterTurnOverCD;                                   // 0x026C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FollowSegmentTolerance;                                   // 0x0270(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0274(0x0004) MISSED OFFSET
	class UCurveFloat*                                 CurveThrottleInput;                                       // 0x0278(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinAngleWhenPivotSteering;                                // 0x0280(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0284(0x0004) MISSED OFFSET
	class UCurveFloat*                                 CurveThrottleRateWhenTurning;                             // 0x0288(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 CurveSteeringInput;                                       // 0x0290(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseBrakeWhenTurning;                                     // 0x0298(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0299(0x0003) MISSED OFFSET
	float                                              MinRequiredSteeringChange;                                // 0x029C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinLengthRateAlmostReach;                                 // 0x02A0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x02A4(0x0004) MISSED OFFSET
	class UCurveFloat*                                 CurveBrakeAlmostReach;                                    // 0x02A8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SteeringThresholdUseBrake;                                // 0x02B0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SpeedThresholdUseBrake;                                   // 0x02B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bBlockTest : 1;                                           // 0x02B8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData05[0x3];                                       // 0x02B9(0x0003) MISSED OFFSET
	float                                              BlockTestingTime;                                         // 0x02BC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BlockSpeedThresholdKMH;                                   // 0x02C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x4];                                       // 0x02C4(0x0004) MISSED OFFSET
	class UClass*                                      DeadInventoryBoxTemplate;                                 // 0x02C8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                DropID;                                                   // 0x02D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x4];                                       // 0x02D4(0x0004) MISSED OFFSET
	struct FName                                       WrapperBoxName;                                           // 0x02D8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class APlayerTombBox*                              DeadTombBox;                                              // 0x02E0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDebug;                                                   // 0x02E8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x02E9(0x0003) MISSED OFFSET
	int                                                DebugLevel;                                               // 0x02EC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DebugInterval;                                            // 0x02F0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x4];                                       // 0x02F4(0x0004) MISSED OFFSET
	struct FString                                     BehaviorServiceDebugInfo;                                 // 0x02F8(0x0010) (BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData10[0x50];                                      // 0x0308(0x0050) MISSED OFFSET
	class ASTExtraVehicleBase*                         OwnerVehicle;                                             // 0x0358(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bCacheMeshOnHit : 1;                                      // 0x0360(0x0001)
	unsigned char                                      UnknownData11[0x27];                                      // 0x0361(0x0027) MISSED OFFSET
...
{
public:
	class UCurveFloat*                                 AimDurationCurve;                                         // 0x0388(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   AimDurationDeviation;                                     // 0x0390(0x0008) (Edit, IsPlainOldData)
	float                                              ShootTurretCD;                                            // 0x0398(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              BulletExplosionRange;                                     // 0x039C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              AimingLockRange;                                          // 0x03A0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              AimingLockRangeWhenFiring;                                // 0x03A4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   TurretAimRange;                                           // 0x03A8(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	unsigned char                                      bPredictEnemyMove : 1;                                    // 0x03B0(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x03B1(0x0003) MISSED OFFSET
	struct FVector2D                                   TurretShootRange;                                         // 0x03B4(0x0008) (Edit, IsPlainOldData)
	unsigned char                                      bAimingConstantLerp : 1;                                  // 0x03BC(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x03BD(0x0003) MISSED OFFSET
	float                                              TurretAimingInterpConstantSpeed;                          // 0x03C0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              TurretAimingInterpSpeed;                                  // 0x03C4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SimTurretAimingInterpConstantSpeed;                       // 0x03C8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              TurretAimingErrorTolerance;                               // 0x03CC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bAlsoCheckArcLength : 1;                                  // 0x03D0(0x0001) (Edit)
	unsigned char                                      UnknownData02[0x3];                                       // 0x03D1(0x0003) MISSED OFFSET
	float                                              ShootTargetLocationOffset;                                // 0x03D4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bTraceBlockShootTargetLocation : 1;                       // 0x03D8(0x0001) (Edit)
	unsigned char                                      UnknownData03[0x3];                                       // 0x03D9(0x0003) MISSED OFFSET
	int                                                MaxTraceBlockTryTimes;                                    // 0x03DC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bResetTurretAfterDestroy : 1;                             // 0x03E0(0x0001) (Edit)
	unsigned char                                      bFailedAimingWhenTurretCollided : 1;                      // 0x03E0(0x0001) (Edit)
	unsigned char                                      UnknownData04[0x7];                                       // 0x03E1(0x0007) MISSED OFFSET
	TMap<float, float>                                 BaseHitRate;                                              // 0x03E8(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              ShootMGCD;                                                // 0x0438(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   ShootMGDuration;                                          // 0x043C(0x0008) (Edit, IsPlainOldData)
	float                                              ShootMGInterval;                                          // 0x0444(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   ShootUpDownRange;                                         // 0x0448(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootLeftRightRange;                                      // 0x0450(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootLeftRightRangeDistance;                              // 0x0458(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootTargetSpeedRange;                                    // 0x0460(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootTargetDistanceRangeDueToSpeed;                       // 0x0468(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   MGShootRange;                                             // 0x0470(0x0008) (Edit, IsPlainOldData)
	unsigned char                                      bShouldMissOnPurpose : 1;                                 // 0x0478(0x0001)
	unsigned char                                      bCacheUsingMG : 1;                                        // 0x0478(0x0001)
	unsigned char                                      bCacheUsingTurret : 1;                                    // 0x0478(0x0001)
...
{
public:
	unsigned char                                      UnknownData00[0x50];                                      // 0x01D8(0x0050) UNKNOWN PROPERTY: SetProperty AI.AIPerceptionChildPickUpComponent.ChildPickUpWrapperActors
...
public:
	...
	bool                                               CheckVisible;                                             // 0x01F8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x01F9(0x0007) MISSED OFFSET
	TArray<class UStaticMeshComponent*>                CheckVisibleMeshComponents;                               // 0x0200(0x0010) (ExportObject, ZeroConstructor)
	uint32_t                                           CustomUInt32State;                                        // 0x0210(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x0214(0x000C) MISSED OFFSET
	bool                                               IsMovable;                                                // 0x0220(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               IsCheckVisAngle;                                          // 0x0221(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               IsFireSpreadingCalCenter;                                 // 0x0222(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
// 0x1418 (0x15F0 - 0x01D8)
class UAIStateInfoComponentBase : public UAIBasicStateInfoComponent
{
public:
	struct FAIStateInfoBaseMod                         CacheAIStateInfoBaseMod;                                  // 0x01D8(0x0460)
	struct FAIStateInfoBaseMod                         LastAIStateInfoBaseMod;                                   // 0x0638(0x0460)
	struct FDiffAIStateInfoBaseModGeneral              CacheDiffAIStateInfoBaseModGeneral;                       // 0x0A98(0x05D0)
	struct FDiffAIStateInfoBaseMod                     CacheDiffAIStateInfoBaseMod;                              // 0x1068(0x0428)
	bool                                               IsTouchedPlayer;                                          // 0x1490(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x1491(0x0003) MISSED OFFSET
	uint32_t                                           FrameNo;                                                  // 0x1494(0x0004) (ZeroConstructor, IsPlainOldData)
	class ASTExtraPlayerController*                    MyPlayerController;                                       // 0x1498(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                SkipFrameConfig;                                          // 0x14A0(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SkipFrameConfigSecond;                                    // 0x14A4(0x0004) (ZeroConstructor, IsPlainOldData)
	class AController*                                 OwnerController;                                          // 0x14A8(0x0008) (ZeroConstructor, IsPlainOldData)
	class ANewFakePlayerAIController*                  MyAIController;                                           // 0x14B0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UAIActingComponent*                          AIActingComp;                                             // 0x14B8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class APawn*                                       MyOwnerPawn;                                              // 0x14C0(0x0008) (ZeroConstructor, IsPlainOldData)
	class ABattleRoyaleGameModeBase*                   MyGameMode;                                               // 0x14C8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x48];                                      // 0x14D0(0x0048) MISSED OFFSET
	TArray<struct FDamageSource>                       DamageSourcesInfoNew;                                     // 0x1518(0x0010) (ZeroConstructor)
	TMap<int, class APickUpWrapperActor*>              CacheAINearbyItem;                                        // 0x1528(0x0050) (ZeroConstructor)
	TArray<class ASTExtraBaseCharacter*>               CacheNearbyEnemies;                                       // 0x1578(0x0010) (ZeroConstructor)
	struct FCacheNearbyItemState                       CacheNearbyItemState;                                     // 0x1588(0x0020)
	class UMLAIControllerComponent*                    MyMLAIControllerComp;                                     // 0x15A8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	uint32_t                                           CacheModeMapId;                                           // 0x15B0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xC];                                       // 0x15B4(0x000C) MISSED OFFSET
	class UMLAISubSystem*                              MLAISubSystem;                                            // 0x15C0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMLAIUtilsBase*                              MLAIUtils;                                                // 0x15C8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UAIStateInfoDataAsset*                       AIStateInfoDataAsset;                                     // 0x15D0(0x0008) (ZeroConstructor, IsPlainOldData)
	class AAIWorldVolume*                              AIWorldVolume;                                            // 0x15D8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x10];                                      // 0x15E0(0x0010) MISSED OFFSET
	...
	void QueryItemStates(int MaxBoxNum, int MaxItemNum, float AirDropBoxRangeInner, float AirDropBoxRangeOuter, float DeathBoxRange, float PickUpWrapperRange, float FindBuildingRange, bool InIsUseItemSpotLoc, int MaxTreasureChestNum, float TreasureChestRange, int MaxWeedNum, float WeedRange, TArray<struct FItemStateData>* ItemStateDatas);
...
// 0x08E0 (0x1ED0 - 0x15F0)
class UAIStateInfoComponentBRBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoBRBase                          CacheAIStateInfoBRBase;                                   // 0x15F0(0x0208)
	struct FAIStateInfoBRBase                          LastAIStateInfoBRBase;                                    // 0x17F8(0x0208)
	struct FDiffAIStateInfoBRBaseGeneral               CacheDiffAIStateInfoBRBaseGeneral;                        // 0x1A00(0x0298)
	struct FDiffAIStateInfoBRBase                      CacheDiffAIStateInfoBRBase;                               // 0x1C98(0x0218)
	unsigned char                                      UnknownData00[0x8];                                       // 0x1EB0(0x0008) MISSED OFFSET
	class UMLAIUtilsBRBase*                            MLAIUtilsBR;                                              // 0x1EB8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x10];                                      // 0x1EC0(0x0010) MISSED OFFSET
...
// 0x0220 (0x1810 - 0x15F0)
class UAIStateInfoComponentMPBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoMPBase                          CacheAIStateInfoMPBase;                                   // 0x15F0(0x00B0)
	struct FAIStateInfoMPBase                          LastAIStateInfoMPBase;                                    // 0x16A0(0x00B0)
	struct FDiffAIStateInfoMPBaseGeneral               CacheDiffAIStateInfoMPBaseGeneral;                        // 0x1750(0x00C0)
...
// 0x00F0 (0x1900 - 0x1810)
class UAIStateInfoComponentTeamDeath : public UAIStateInfoComponentMPBase
{
public:
	struct FAIStateInfoTeamDeath                       CacheAIStateInfoTeamDeath;                                // 0x1810(0x0050)
	struct FAIStateInfoTeamDeath                       LastAIStateInfoTeamDeath;                                 // 0x1860(0x0050)
	struct FDiffAIStateInfoTeamDeathGeneral            CacheDiffAIStateInfoTeamDeathGeneral;                     // 0x18B0(0x0050)
...
public:
	...
	float                                              NearbyFindBuildingRange;                                  // 0x01CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ItemStateChangedRange;                                    // 0x01D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsItemVisiable;                                           // 0x01D4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsUseItemSpotLoc;                                         // 0x01D5(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x01D6(0x0002) MISSED OFFSET
	float                                              NearbyObstacleRange;                                      // 0x01D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyThrownRange;                                        // 0x01DC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbySmokeRange;                                         // 0x01E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                NearbyThrownMaxNum;                                       // 0x01E4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x01E8(0x0004) MISSED OFFSET
	int                                                NearbyDoorMaxNum;                                         // 0x01EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyVehicleRange;                                       // 0x01F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	int                                                NearbyVehicleMaxNum;                                      // 0x01F4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyBulletHoleRange;                                    // 0x01F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                NearbyBulletHoleMaxNum;                                   // 0x01FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyDynamicItemsRange;                                  // 0x0200(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyDynamicItemsVisibleAngle;                           // 0x0204(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                NearbyDynamicItemsMaxNum;                                 // 0x0208(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyMonsterRange;                                       // 0x020C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                NearbyMonsterMaxNum;                                      // 0x0210(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyDigLandScapeActorRange;                             // 0x0214(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                NearbyDigLandScapeActorMaxNum;                            // 0x0218(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreTreeAIWhenNoPlayerAround;                          // 0x021C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x021D(0x0003) MISSED OFFSET
	float                                              IgnoreTreeAIRadius;                                       // 0x0220(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               UseBodyTPPCamera;                                         // 0x0224(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0225(0x0003) MISSED OFFSET
	TArray<int>                                        IgnoredMonsterIDs;                                        // 0x0228(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<EAvatarSlotType>                            AvailableAvatarSlotTypes;                                 // 0x0238(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	uint32_t                                           nCanMLAIBuildAttributeID;                                 // 0x0248(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData00[0x60];                                      // 0x0950(0x0060) MISSED OFFSET
...
public:
	...
	struct FDiffAllPlayerBRBaseInfo                    CacheAllPlayersInfoCSS;                                   // 0x0248(0x04D8)
	struct FGlobalGameBRBaseState                      CacheGlobalGameState;                                     // 0x0720(0x00F8)
	struct FGlobalGameBRBaseState                      LastGlobalGameState;                                      // 0x0818(0x00F8)
	struct FDiffGlobalGameBRBaseState                  DiffGlobalGameState;                                      // 0x0910(0x0148)
	struct FDiffGlobalGameBRBaseStateGeneral           DiffGlobalGameStateGeneral;                               // 0x0A58(0x0168)
	unsigned char                                      UnknownData00[0x30];                                      // 0x0BC0(0x0030) MISSED OFFSET
	class UCircleMgrComponent*                         CircleMgr;                                                // 0x0BF0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	EAISearchEnemyEntityType                           SearchEnemyEntityType;                                    // 0x00C9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UClass*                                      AIActionExcutionCompClass;                                // 0x01D8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UClass*                                      AISoundCollectCompClass;                                  // 0x01E0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UClass*                                      AIStateInfoCompClass;                                     // 0x01E8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UClass*                                      MLAIParachuteJumpCompClass;                               // 0x01F0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UAIActionExecutionComponent*                 AIActionExecutionComp;                                    // 0x01F8(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAIBasicStateInfoComponent*                  AIStateInfoComp;                                          // 0x0200(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAISoundCollectionComponent*                 AISoundCollectComp;                                       // 0x0208(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UMLAIParachuteJumpComponent*                 MLAIParachuteJumpComp;                                    // 0x0210(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UTeammateMLAIControllerComponent*            TeammateMLAIControllerComp;                               // 0x0218(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	float                                              HearRadius;                                               // 0x0220(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0224(0x0004) MISSED OFFSET
	TMap<TEnumAsByte<enum ESTEPoseState>, struct FCameraViewPitchLimitData> CameraViewPitchLimitDataMap;                              // 0x0228(0x0050) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FCameraViewPitchLimitData                   FreeFallCameraViewPitchLimitData;                         // 0x0278(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FVector                                     PrePos;                                                   // 0x0280(0x000C) (IsPlainOldData)
	float                                              PreTickTime;                                              // 0x028C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0290(0x0008) MISSED OFFSET
	class AController*                                 OwnerController;                                          // 0x0298(0x0008) (ZeroConstructor, IsPlainOldData)
	class ANewFakePlayerAIController*                  MyAIController;                                           // 0x02A0(0x0008) (ZeroConstructor, IsPlainOldData)
	class ASTExtraPlayerController*                    MyPlayerController;                                       // 0x02A8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x14];                                      // 0x02B0(0x0014) MISSED OFFSET
	float                                              FindNavLocationRadius;                                    // 0x02C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxNavLocationFindTimes;                                  // 0x02C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLerpRotation;                                         // 0x02CC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x02CD(0x0003) MISSED OFFSET
	float                                              LerpRotationThreshold;                                    // 0x02D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsForceTargetRotation;                                    // 0x02D4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x02D5(0x0003) MISSED OFFSET
	float                                              FirstLerpRotationDeltaTime;                               // 0x02D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FreeCameraTurnVelocity;                                   // 0x02DC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              TurnVelocity;                                             // 0x02E0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x02E4(0x0004) MISSED OFFSET
	struct FAIShootingPoseOffsetInfo                   shootingPoseOffsetInfo;                                   // 0x02E8(0x0070) (Edit)
	float                                              AutoOpenDoorRange;                                        // 0x0358(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x8];                                       // 0x035C(0x0008) MISSED OFFSET
	bool                                               IsModifyDamageLuaOverride;                                // 0x0364(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x3];                                       // 0x0365(0x0003) MISSED OFFSET
	float                                              RatingDamageScaleLuaOverride;                             // 0x0368(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bShouldSendVehicleInfo;                                   // 0x036C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x1B];                                      // 0x036D(0x001B) MISSED OFFSET
	bool                                               IsChangeStatePC;                                          // 0x0388(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x3];                                       // 0x0389(0x0003) MISSED OFFSET
	uint32_t                                           AllyMasterID;                                             // 0x038C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x460];                                     // 0x0390(0x0460) MISSED OFFSET
...
public:
	...
	struct FDiffAllPlayerLandScapeDestroyInfo          CacheAllPlayersInfoCSS;                                   // 0x0140(0x00B8)
	struct FGlobalLandScapeChangeInfo                  CacheGlobalGameState;                                     // 0x01F8(0x0028)
	struct FGlobalLandScapeChangeInfo                  LastGlobalGameState;                                      // 0x0220(0x0028)
	struct FDiffGlobalLandScapeChangeInfoGeneral       DiffGlobalGameStateGeneral;                               // 0x0248(0x0050)
...
public:
	...
	class ASTExtraPlayerController*                    OwnerPlayerController;                                    // 0x0200(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              FallingTime;                                              // 0x0208(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CheckCountTime;                                           // 0x020C(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bLandingInLowHeight;                                      // 0x0210(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0211(0x0003) MISSED OFFSET
	struct FVector                                     LastLocation;                                             // 0x0214(0x000C) (IsPlainOldData)
	bool                                               bDellJumpToLandExcute;                                    // 0x0220(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bNotiyParachuteComp;                                      // 0x0221(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x6];                                       // 0x0222(0x0006) MISSED OFFSET
	struct FName                                       IgnoreOpen;                                               // 0x0228(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData01[0x200];                                     // 0x0138(0x0200) MISSED OFFSET
	TMap<uint32_t, bool>                               AlreadySendDeadStateMap;                                  // 0x0338(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0388(0x0008) MISSED OFFSET
	struct FRedZoneState                               CacheRedZoneInfo;                                         // 0x0390(0x0030)
	float                                              AirAttackTotalTime;                                       // 0x03C0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x03C4(0x0004) MISSED OFFSET
	class UAirAttackComponent*                         AirAttackComp;                                            // 0x03C8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FGlobalGameStateBRBase                      GlobalGameState;                                          // 0x03D0(0x0170)
	struct FGlobalGameStateBRBase                      LastGlobalGameState;                                      // 0x0540(0x0170)
	class UMLAIUtilsBase*                              MLAIUtils;                                                // 0x06B0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x70];                                      // 0x06B8(0x0070) MISSED OFFSET
	TMap<uint32_t, int>                                CachePlayerRevivalTypes;                                  // 0x0728(0x0050) (ZeroConstructor)
	class UMLAIStateInfoManager*                       MLAIStateInfoManager;                                     // 0x0778(0x0008) (ZeroConstructor, IsPlainOldData)
	TMap<uint32_t, struct FString>                     VoiceRoomInfoMap;                                         // 0x0780(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FString>                     VoiceServerURLMap;                                        // 0x07D0(0x0050) (ZeroConstructor)
	int                                                AirDropTag;                                               // 0x0820(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0824(0x0004) MISSED OFFSET
	float                                              ProduceSoundInterval;                                     // 0x0828(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                nCanJumpToSky;                                            // 0x082C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                nNewbieRealHiddenScore;                                   // 0x0830(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                nNewbieMatchCount;                                        // 0x0834(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x50];                                      // 0x0838(0x0050) UNKNOWN PROPERTY: SetProperty AI.MLAISubSystem.TeammateMLAITeamIDSet
	TArray<uint32_t>                                   SilentMLAIList;                                           // 0x0888(0x0010) (ZeroConstructor)
	bool                                               WhitelistPlayerStatesSwitch;                              // 0x0898(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x7];                                       // 0x0899(0x0007) MISSED OFFSET
	TArray<uint32_t>                                   PlayerWhitelist;                                          // 0x08A0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData08[0x8];                                       // 0x08B0(0x0008) MISSED OFFSET
	TMap<class AActor*, class ASpecialZoneActor*>      CacheSpecialZoneParents;                                  // 0x08B8(0x0050) (ZeroConstructor)
	TArray<class ASpecialZoneActor*>                   CacheDynamicSpecialZone;                                  // 0x0908(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData09[0x18];                                      // 0x0918(0x0018) MISSED OFFSET
	class ABattleRoyaleGameMode*                       CurGameMode;                                              // 0x0930(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	void SetNonMLAIBuffConfig(TArray<int> InBuffIDs);
	...
	void SetCDSkillConfig(TArray<int> InSkillIDs);
...
public:
	...
	struct FGlobalGameStateBRBase                      CacheGlobalGameStateBRBase;                               // 0x0AA8(0x0170)
	struct FGlobalGameStateBRBase                      LastGlobalGameStateBRBase;                                // 0x0C18(0x0170)
	struct FDiffGlobalGameStateBRBase                  DiffGlobalGameStateBRBase;                                // 0x0D88(0x0148)
	struct FDiffGlobalGameStateBRBaseGeneral           DiffGlobalGameStateBRBaseGeneral;                         // 0x0ED0(0x02A8)
	struct FRedZoneState                               CacheRedZoneInfo;                                         // 0x1178(0x0030)
	TArray<struct FAIStateInfoBRBase>                  CacheAllPlayersInfoBRBase;                                // 0x11A8(0x0010) (ZeroConstructor)
	struct FDiffAllPlayerInfoBRBaseGeneral             CacheDiffAllPlayersInfoBRBaseGeneral;                     // 0x11B8(0x0098)
	struct FDiffAllPlayerInfoBRBase                    CacheAllPlayersInfoBRBaseCSS;                             // 0x1250(0x0350)
	TMap<uint32_t, struct FAIStateInfoBRBase>          LastAllPlayerInfoMapBRBase;                               // 0x15A0(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x30];                                      // 0x15F0(0x0030) MISSED OFFSET
	class UCircleMgrComponent*                         CircleMgr;                                                // 0x1620(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x10];                                      // 0x1628(0x0010) MISSED OFFSET
...
{
public:
	float                                              Radius;                                                   // 0x0448(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                Type;                                                     // 0x044C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsDynamic;                                                // 0x0450(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0451(0x0003) MISSED OFFSET
	int                                                CustomState;                                              // 0x0454(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsDestructibleMesh;                                       // 0x0458(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsInstanced;                                              // 0x0459(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x045A(0x0002) MISSED OFFSET
	int                                                InstancedMaxNum;                                          // 0x045C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TMap<struct FString, int>                          StaticMeshNameToType;                                     // 0x0460(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               CheckNearHaveAI;                                          // 0x04B0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x04B1(0x0003) MISSED OFFSET
	float                                              CheckAIDist;                                              // 0x04B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USpecialZoneShapeComponent*                  SpecialZoneShapeComponent;                                // 0x04B8(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class AActor*                                      CacheParentActor;                                         // 0x04C0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x04C8(0x0001) MISSED OFFSET
	bool                                               IsCharacter;                                              // 0x04C9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x2];                                       // 0x04CA(0x0002) MISSED OFFSET
	uint32_t                                           ExtraState;                                               // 0x04CC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              Health;                                                   // 0x04D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsSpawnBTAINeedCheck;                                     // 0x04D4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0xB];                                       // 0x04D5(0x000B) MISSED OFFSET
	class AAIWorldVolume*                              AIWorldVolume;                                            // 0x04E0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UInstancedStaticMeshComponent*               CacheInstancedMeshComp;                                   // 0x04E8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class USTDestructionComponent*                     CacheDestructibleMeshComp;                                // 0x04F0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
// 0x0440 (0x0618 - 0x01D8)
class UTeammateMLAIControllerComponent : public ULuaActorComponent
{
public:
	struct FString                                     DefaultLuaFilePath;                                       // 0x01D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FGameModeAIPlayerParams                     AIParams;                                                 // 0x01E8(0x0400)
	uint32_t                                           AILevel;                                                  // 0x05E8(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           MLAIStyle;                                                // 0x05EC(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           TargetPlayerKey;                                          // 0x05F0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x05F4(0x0004) MISSED OFFSET
	class ASTExtraPlayerController*                    OwnerPlayerController;                                    // 0x05F8(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              DefaultExitTime;                                          // 0x0600(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0604(0x0004) MISSED OFFSET
	struct FTimerHandle                                TeammateMLAIExitTimer;                                    // 0x0608(0x0008)
	bool                                               bIsTakeOverTeammate;                                      // 0x0610(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class ASTExtraVehicleBase*                         ControlledVehicle;                                        // 0x0848(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FAIVehicleStateData                         AIVehicleStateData;                                       // 0x0850(0x0080)
	class UAIBehaviorAdapter_VehicleBase*              AIBehaviorAdapter;                                        // 0x08D0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
