...
struct FPacket
{
	...
	unsigned char                                      Payload[0x1E0];                                           // 0x0006(0x0001) (ZeroConstructor, IsPlainOldData)
	uint16_t                                           PayloadLength;                                            // 0x01E6(0x0002) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      Alignment[0x18];                                          // 0x01E8(0x0001) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
};
...
struct FTransferTask
{
	...
	double                                             TransferTime;                                             // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<bool>                                       Confirmed;                                                // 0x0010(0x0010) (ZeroConstructor)
