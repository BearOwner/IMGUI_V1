...
public:
	...
	float                                              BeaconConnectionInitialTimeout;                           // 0x0450(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              BeaconConnectionTimeout;                                  // 0x0454(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UNetDriver*                                  NetDriver;                                                // 0x0458(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AOnlineBeaconHostObject*                     BeaconOwner;                                              // 0x0470(0x0008) (ZeroConstructor, IsPlainOldData)
	class UNetConnection*                              BeaconConnection;                                         // 0x0478(0x0008) (ZeroConstructor, IsPlainOldData)
	EBeaconConnectionState                             ConnectionState;                                          // 0x0480(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2F];                                      // 0x0481(0x002F) MISSED OFFSET
...
{
public:
	int                                                ListenPort;                                               // 0x0470(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0474(0x0004) MISSED OFFSET
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x0478(0x0010) (ZeroConstructor)
...
{
public:
	struct FString                                     BeaconTypeName;                                           // 0x0448(0x0010) (ZeroConstructor, Transient)
	class UClass*                                      ClientBeaconActorClass;                                   // 0x0458(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FString                                     DestSessionId;                                            // 0x04E0(0x0010) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x04F0(0x0030)
	EClientRequestType                                 RequestType;                                              // 0x0520(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingReservationSent;                                  // 0x0521(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCancelReservation;                                       // 0x0522(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class UPartyBeaconState*                           State;                                                    // 0x0470(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x50];                                      // 0x0478(0x0050) MISSED OFFSET
	bool                                               bLogoutOnSessionTimeout;                                  // 0x04C8(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x04C9(0x0003) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x04CC(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x04D0(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
