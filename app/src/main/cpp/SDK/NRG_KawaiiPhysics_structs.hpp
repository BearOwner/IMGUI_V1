...
struct FKawaiiPhysicsModifyBone
{
	...
	bool                                               bExcluded;                                                // 0x00A1(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xE];                                       // 0x00A2(0x000E) MISSED OFFSET
};

// ScriptStruct KawaiiPhysics.NewAnimNode_KawaiiPhysics
// 0x0188 (0x0200 - 0x0078)
struct FNewAnimNode_KawaiiPhysics : public FAnimNode_SkeletalControlBase
{
	...
	TArray<struct FBoneReference>                      FixedBones;                                               // 0x00A0(0x0010) (Edit, ZeroConstructor)
	int                                                TargetFramerate;                                          // 0x00B0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               OverrideTargetFramerate;                                  // 0x00B4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00B5(0x0003) MISSED OFFSET
	struct FKawaiiPhysicsSettings                      PhysicsSettings;                                          // 0x00B8(0x0018) (Edit, BlueprintVisible)
	class UCurveFloat*                                 DampingCurve;                                             // 0x00D0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 WorldDampingLocationCurve;                                // 0x00D8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 WorldDampingRotationCurve;                                // 0x00E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 StiffnessCurve;                                           // 0x00E8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 RadiusCurve;                                              // 0x00F0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 LimitAngleCurve;                                          // 0x00F8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUpdatePhysicsSettingsInGame;                             // 0x0100(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0101(0x0003) MISSED OFFSET
	float                                              DummyBoneLength;                                          // 0x0104(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EPlanarConstraint                                  PlanarConstraint;                                         // 0x0108(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0109(0x0007) MISSED OFFSET
	TArray<struct FSphericalLimit>                     SphericalLimits;                                          // 0x0110(0x0010) (Edit, ZeroConstructor)
	TArray<struct FCapsuleLimit>                       CapsuleLimits;                                            // 0x0120(0x0010) (Edit, ZeroConstructor)
	TArray<struct FPlanarLimit>                        PlanarLimits;                                             // 0x0130(0x0010) (Edit, ZeroConstructor)
	float                                              TeleportDistanceThreshold;                                // 0x0140(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              TeleportRotationThreshold;                                // 0x0144(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Gravity;                                                  // 0x0148(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     MaxDistance;                                              // 0x0154(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     MinDistance;                                              // 0x0160(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bEnableWind;                                              // 0x016C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x016D(0x0003) MISSED OFFSET
	float                                              WindScale;                                                // 0x0170(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0174(0x0004) MISSED OFFSET
	TArray<struct FKawaiiPhysicsModifyBone>            ModifyBones;                                              // 0x0178(0x0010) (ZeroConstructor)
	float                                              TotalBoneLength;                                          // 0x0188(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x018C(0x0004) MISSED OFFSET
	struct FTransform                                  PreSkelCompTransform;                                     // 0x0190(0x0030) (IsPlainOldData)
	bool                                               bInitPhysicsSettings;                                     // 0x01C0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3F];                                      // 0x01C1(0x003F) MISSED OFFSET
};
...
struct FAnimNode_KawaiiPhysics : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData06[0x3F];                                      // 0x01A1(0x003F) MISSED OFFSET
};
