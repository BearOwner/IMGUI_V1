...
public:
	...
	class UBlockyGraphData*                            HostWidget;                                               // 0x0068(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0070(0x0010) MISSED OFFSET
	class UFunctionDesc*                               FunctionDesc;                                             // 0x0080(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FString                                     DisplayName;                                              // 0x0088(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData03[0x148];                                     // 0x0098(0x0148) MISSED OFFSET
	struct FString                                     QuoteVariableName;                                        // 0x01E0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               bIsDisable;                                               // 0x01F0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
// 0x0220 (0x0418 - 0x01F8)
class UExecuteable : public UBlockBase
{
public:
	unsigned char                                      UnknownData00[0x1B8];                                     // 0x01F8(0x01B8) MISSED OFFSET
	TMap<struct FString, struct FBlockParam>           BlockParams;                                              // 0x03B0(0x0050) (BlueprintVisible, ZeroConstructor)
	TArray<class UNamedVar*>                           FuncVars;                                                 // 0x0400(0x0010) (BlueprintVisible, ZeroConstructor)
...
// 0x0310 (0x0728 - 0x0418)
class UAddArrayElement : public UExecuteable
{
public:
	unsigned char                                      UnknownData00[0x310];                                     // 0x0418(0x0310) MISSED OFFSET
...
// 0x04F8 (0x06F0 - 0x01F8)
class UArithmetic : public UBlockBase
{
public:
	unsigned char                                      UnknownData00[0x4F8];                                     // 0x01F8(0x04F8) MISSED OFFSET
...
// 0x0190 (0x0388 - 0x01F8)
class UArrayLength : public UBlockBase
{
public:
	unsigned char                                      UnknownData00[0x188];                                     // 0x01F8(0x0188) MISSED OFFSET
	class UBrushData*                                  BrushBGSelected;                                          // 0x0380(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
// 0x02F8 (0x04F0 - 0x01F8)
class UNamedVar : public UVarBase
{
public:
	struct FText                                       Name;                                                     // 0x01F8(0x0018) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0210(0x0008) MISSED OFFSET
	struct FString                                     NameInCode;                                               // 0x0218(0x0010) (ZeroConstructor)
	bool                                               IsValueValid;                                             // 0x0228(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsInitColorLoad;                                          // 0x0229(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x6];                                       // 0x022A(0x0006) MISSED OFFSET
	TArray<class UNamedVar*>                           CopiedChildVarCache;                                      // 0x0230(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x1D8];                                     // 0x0240(0x01D8) MISSED OFFSET
	bool                                               bIsArray;                                                 // 0x0418(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7];                                       // 0x0419(0x0007) MISSED OFFSET
	struct FString                                     InitValueString;                                          // 0x0420(0x0010) (ZeroConstructor)
	class UColorDesc*                                  ColorDesc;                                                // 0x0430(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UColorDesc*>                          ArrayColorDesc;                                           // 0x0438(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                NowColorArrayIdx;                                         // 0x0448(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               NowColorIsArray;                                          // 0x044C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x044D(0x0003) MISSED OFFSET
	class UNamedVar*                                   Source;                                                   // 0x0450(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData05[0x40];                                      // 0x0458(0x0040) MISSED OFFSET
	class UBrushData*                                  CopyBrush;                                                // 0x0498(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	TArray<class UBlockBase*>                          RootBlocks;                                               // 0x00C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<class UNamedVar*>                           LocalVars;                                                // 0x00D0(0x0010) (ZeroConstructor)
	int                                                CurrentVisibleBlockNum;                                   // 0x00E0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xC];                                       // 0x00E4(0x000C) MISSED OFFSET
	class UCanvasRenderTarget2D*                       RenderTarget;                                             // 0x00F0(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   ViewPosition;                                             // 0x00F8(0x0008) (BlueprintVisible, IsPlainOldData)
	struct FBlockPoint                                 ViewSize;                                                 // 0x0100(0x0008) (BlueprintVisible)
	float                                              ViewScale;                                                // 0x0108(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x34];                                      // 0x010C(0x0034) MISSED OFFSET
...
public:
	...
	TArray<class UNamedVar*>                           GlobalVars;                                               // 0x00F0(0x0010) (ZeroConstructor)
	class UCustomConfig*                               EditingCustomConfig;                                      // 0x0100(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TMap<struct FGuid, class UCustomConfig*>           TemplateCustomConfigs;                                    // 0x0108(0x0050) (ZeroConstructor)
	class UExecuteable*                                CurrExeBlock;                                             // 0x0158(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UExecuteable*                                EditingExeBlock;                                          // 0x0160(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UBlockyGraph*>                        SubBlockyGraphs;                                          // 0x0168(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TArray<class UBlockyGraph*>                        BlockyGraphsCallStack;                                    // 0x0178(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TMap<struct FString, struct FString>               CacheData;                                                // 0x0188(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FText                                       Name;                                                     // 0x01D8(0x0018)
	class UBlockBase*                                  CurrentPutSlotHostBlock;                                  // 0x01F0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x18];                                      // 0x01F8(0x0018) MISSED OFFSET
	class UBlockBase*                                  CurrentPutSlotReplacedBlock;                              // 0x0210(0x0008) (ZeroConstructor, IsPlainOldData)
	class UBlockBase*                                  CurrentTopPutBlock;                                       // 0x0218(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x8];                                       // 0x0220(0x0008) MISSED OFFSET
	class UBlockBase*                                  CurrentSettingBlock;                                      // 0x0228(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USelectionData*                              CurrentSelection;                                         // 0x0230(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USelectionData*                              CurrentPointAt;                                           // 0x0238(0x0008) (ZeroConstructor, IsPlainOldData)
	class UExecuteablePreview*                         BlockPreview;                                             // 0x0240(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnSaveProgress;                                           // 0x0248(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	bool                                               IsGraphDirty;                                             // 0x0258(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsLoading;                                                // 0x0259(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0xE];                                       // 0x025A(0x000E) MISSED OFFSET
	class UBrushData*                                  DefaultRectBrush;                                         // 0x0268(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterial*                                   PreViewMaterial;                                          // 0x0270(0x0008) (ZeroConstructor, IsPlainOldData)
	class UBrushData*                                  PreViewBrush;                                             // 0x0278(0x0008) (ZeroConstructor, IsPlainOldData)
	class UBrushData*                                  AnimateBrush;                                             // 0x0280(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInstanceDynamic*                    DeleteUIDynamicMaterial;                                  // 0x0288(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInstanceDynamic*                    DeleteRangeUIDynamicMaterial;                             // 0x0290(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInstanceDynamic*                    DeleteUIBgDynamicMaterial;                                // 0x0298(0x0008) (ZeroConstructor, IsPlainOldData)
	class UBrushData*                                  DeleteRangeUIDockingBrush;                                // 0x02A0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UBrushData*                                  DeleteUIDockingBrush;                                     // 0x02A8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UBrushData*                                  DeleteUIBgBrush;                                          // 0x02B0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x20];                                      // 0x02B8(0x0020) MISSED OFFSET
	class UBlockBase*                                  TouchBlockHostSlotHost;                                   // 0x02D8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0xE8];                                      // 0x02E0(0x00E8) MISSED OFFSET
	struct FScriptDelegate                             OnOpenCustomPanel;                                        // 0x03C8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnOpenCustomPopup;                                        // 0x03D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnOpenCustomSavePopup;                                    // 0x03E8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCloseCustomPopup;                                       // 0x03F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnOpenVariablePopup;                                      // 0x0408(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnOpenBlackboardPopup;                                    // 0x0418(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCloseVariablePopup;                                     // 0x0428(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnUpdateUndoRedoState;                                    // 0x0438(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnShowTips;                                               // 0x0448(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnShowInitUI;                                             // 0x0458(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnOpenVariablePanel;                                      // 0x0468(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnOpenCreateBlackboardPanel;                              // 0x0478(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnOpenEditBlackboardPanel;                                // 0x0488(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnOpenCreateCustomVarPanel;                               // 0x0498(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnOpenEditCustomVarPanel;                                 // 0x04A8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OpenDelCustomVarPanel;                                    // 0x04B8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnQuoteBlock;                                             // 0x04C8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnShowBlockSettingPop;                                    // 0x04D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnOpenCommentPopup;                                       // 0x04E8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCloseCommentPopup;                                      // 0x04F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnSetBlockLogNum;                                         // 0x0508(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnSetBlockLogTabNum;                                      // 0x0518(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnSetBlockLogText;                                        // 0x0528(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnClearBlockLog;                                          // 0x0538(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnOpenAnimationPopup;                                     // 0x0548(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCloseAnimationPopup;                                    // 0x0558(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnShowBlockVariablePopup;                                 // 0x0568(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData08[0x10];                                      // 0x0578(0x0010) MISSED OFFSET
	TArray<struct FString>                             OpendItemStrings;                                         // 0x0588(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FString                                     CurSelectTriggerType;                                     // 0x0598(0x0010) (BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData09[0x1];                                       // 0x05A8(0x0001) MISSED OFFSET
	bool                                               IsOpenedCaption;                                          // 0x05A9(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x16];                                      // 0x05AA(0x0016) MISSED OFFSET
...
// 0x1420 (0x1448 - 0x0028)
class UBlockyLuaConfig : public UObject
{
public:
	int                                                MaxBlockCount;                                            // 0x0028(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	int                                                MaxBlockCountInViewport;                                  // 0x002C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	int                                                MaxBlockCountInOneBlock;                                  // 0x0030(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
	unsigned char                                      UnknownData01[0x50];                                      // 0x0034(0x0050) UNKNOWN PROPERTY: SetProperty BlockyLuaCore.BlockyLuaConfig.DisabledFuncSet
	unsigned char                                      UnknownData02[0x50];                                      // 0x0088(0x0050) UNKNOWN PROPERTY: SetProperty BlockyLuaCore.BlockyLuaConfig.BlockReginsSet
	...
	unsigned char                                      UnknownData04[0x3];                                       // 0x0158(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData08[0x3];                                       // 0x0231(0x0003) MISSED OFFSET
	...
	float                                              DeleteBlocksYOffset;                                      // 0x03AC(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	struct FVector2D                                   DeleteBlocksSize;                                         // 0x03B0(0x0008) (Edit, Config, IsPlainOldData)
	struct FVector2D                                   CanDeleteSize;                                            // 0x03B8(0x0008) (Edit, Config, IsPlainOldData)
	struct FVector2D                                   BlockEmblemSize;                                          // 0x03C0(0x0008) (Edit, Config, IsPlainOldData)
	float                                              DisplayViewMaxBlockWidth;                                 // 0x03C8(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	struct FLinearColor                                DefaultBackColor;                                         // 0x03CC(0x0010) (Edit, Config, IsPlainOldData)
	struct FLinearColor                                DarkBackColor;                                            // 0x03DC(0x0010) (Edit, Config, IsPlainOldData)
	struct FLinearColor                                KeyWordColor;                                             // 0x03EC(0x0010) (Edit, Config, IsPlainOldData)
	struct FLinearColor                                IllegalWordColor;                                         // 0x03FC(0x0010) (Edit, Config, IsPlainOldData)
	struct FLinearColor                                FunctionBackColor;                                        // 0x040C(0x0010) (Edit, Config, IsPlainOldData)
	float                                              BlockSnapAreaLeft;                                        // 0x041C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              BlockSnapAreaTop;                                         // 0x0420(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              BlockSnapAreaWidth;                                       // 0x0424(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              BlockSnapAreaHeight;                                      // 0x0428(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData09[0x4];                                       // 0x042C(0x0004) MISSED OFFSET
	...
	int                                                UndoMaxSteps;                                             // 0x0A40(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	int                                                MaxStoredNumOfSearchHistory;                              // 0x0A44(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               SearchUseCase;                                            // 0x0A48(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x0A49(0x0003) MISSED OFFSET
	struct FLinearColor                                SearchedKeyWordColor;                                     // 0x0A4C(0x0010) (Edit, Config, IsPlainOldData)
	int                                                MaxTemplateDescriptionLen;                                // 0x0A5C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              SaveCooldownDuration;                                     // 0x0A60(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData11[0x4];                                       // 0x0A64(0x0004) MISSED OFFSET
	TMap<struct FString, class UBrushData*>            BlockyBrushDatas;                                         // 0x0A68(0x0050) (ZeroConstructor)
	TMap<struct FString, struct FBlockyBrushInfo>      BlockyBrushInfos;                                         // 0x0AB8(0x0050) (ZeroConstructor)
	TMap<struct FString, struct FString>               RTLBrushMap;                                              // 0x0B08(0x0050) (ZeroConstructor)
	TArray<struct FString>                             BlockyBrushNames;                                         // 0x0B58(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData12[0xA0];                                      // 0x0B68(0x00A0) MISSED OFFSET
	TMap<struct FString, class UFunctionDesc*>         Functions;                                                // 0x0C08(0x0050) (ZeroConstructor)
	TMap<struct FString, class UFunctionDesc*>         FuncTemplates;                                            // 0x0C58(0x0050) (ZeroConstructor)
	TMap<struct FString, class UFunctionDesc*>         TypeFilterFunctions;                                      // 0x0CA8(0x0050) (ZeroConstructor)
	TArray<class UBlackboardDefiner*>                  BlackboardDefiners;                                       // 0x0CF8(0x0010) (ZeroConstructor)
	TMap<struct FString, class UVarDefiner*>           VarDefiners;                                              // 0x0D08(0x0050) (ZeroConstructor)
	TMap<struct FString, class UCustomDefiner*>        CustomDefiners;                                           // 0x0D58(0x0050) (ZeroConstructor)
	TMap<struct FString, class UCategoryDefiner*>      CategoryDefiners;                                         // 0x0DA8(0x0050) (ZeroConstructor)
	TMap<struct FString, class UEnumDesc*>             Enums;                                                    // 0x0DF8(0x0050) (ZeroConstructor)
	TArray<class UBlockyMenuItemObject*>               MenuItems;                                                // 0x0E48(0x0010) (ZeroConstructor)
	TMap<struct FString, class UTypeConvertDesc*>      TypeConverts;                                             // 0x0E58(0x0050) (ZeroConstructor)
	TMap<struct FString, class UPresetDesc*>           PresetDescMap;                                            // 0x0EA8(0x0050) (ZeroConstructor)
	TMap<struct FString, class UPresetDesc*>           CodeNameAndTypeKeyPresetDescMap;                          // 0x0EF8(0x0050) (ZeroConstructor)
	TArray<class UBlockyMenuItemObject*>               PresetMenuItems;                                          // 0x0F48(0x0010) (ZeroConstructor)
	TArray<class UBlockyGraph*>                        TemplateGraphs;                                           // 0x0F58(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData13[0x50];                                      // 0x0F68(0x0050) UNKNOWN PROPERTY: SetProperty BlockyLuaCore.BlockyLuaConfig.AllTypes
	unsigned char                                      UnknownData14[0x50];                                      // 0x0FB8(0x0050) UNKNOWN PROPERTY: SetProperty BlockyLuaCore.BlockyLuaConfig.CustomVarTypes
	TMap<struct FString, struct FString>               TipsMap;                                                  // 0x1008(0x0050) (ZeroConstructor)
	TMap<struct FString, bool>                         BlockyNewsMap;                                            // 0x1058(0x0050) (ZeroConstructor)
	TArray<struct FString>                             MenuSequence;                                             // 0x10A8(0x0010) (ZeroConstructor)
	TMap<struct FString, struct FSequence>             CategorySequence;                                         // 0x10B8(0x0050) (ZeroConstructor)
	TMap<struct FString, struct FSequence>             ItemSequence;                                             // 0x1108(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData15[0x18];                                      // 0x1158(0x0018) MISSED OFFSET
	struct FSlateFontInfo                              FontInfo;                                                 // 0x1170(0x0058)
	unsigned char                                      UnknownData16[0x8];                                       // 0x11C8(0x0008) MISSED OFFSET
	TMap<struct FString, class UVarDefiner*>           AllTypesMap;                                              // 0x11D0(0x0050) (ZeroConstructor)
	TMap<struct FGuid, struct FScriptDelegate>         OnReceiveCheckStringResults;                              // 0x1220(0x0050) (ZeroConstructor)
	struct FScriptDelegate                             OnGetLocaleString;                                        // 0x1270(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCallCustomSelectObject;                                 // 0x1280(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnReceiveCustomSelectObject;                              // 0x1290(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCheckShowCustomSelection;                               // 0x12A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnShowPresetPanelHandler;                                 // 0x12B0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCheckShowPresetFilterBtn;                               // 0x12C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnModifyTip;                                              // 0x12D0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnAddBlockyLog;                                           // 0x12E0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnGetValidString;                                         // 0x12F0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCheckStringValid;                                       // 0x1300(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMessageData;                                            // 0x1310(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnIsCurrentCultureLTR;                                    // 0x1320(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnGetTextLen;                                             // 0x1330(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnPlayPresetSound;                                        // 0x1340(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnOpenGuide;                                              // 0x1350(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnSetGraphSetting;                                        // 0x1360(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnGetBlockNewState;                                       // 0x1370(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnSetBlockNewState;                                       // 0x1380(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData17[0x60];                                      // 0x1390(0x0060) MISSED OFFSET
	class UHotfixUtility*                              HotfixUtility;                                            // 0x13F0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData18[0x50];                                      // 0x13F8(0x0050) MISSED OFFSET
...
public:
	...
	float                                              PaddingLeft;                                              // 0x0098(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                CategoryStringColor;                                      // 0x009C(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              CategoryHeight;                                           // 0x00AC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                ItemStringColor;                                          // 0x00B0(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	class UBlockyGraphData*                            GraphData;                                                // 0x00C0(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bShowRedDot;                                              // 0x00C8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x00C9(0x0007) MISSED OFFSET
	class UBrushData*                                  DefaultRectBrush;                                         // 0x00D0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UBrushData*                                  CurrentItemBrush;                                         // 0x00D8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UBrushData*                                  CurrentIconBrush;                                         // 0x00E0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UBrushData*                                  SelectedIconBrush;                                        // 0x00E8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x18];                                      // 0x00F0(0x0018) MISSED OFFSET
...
{
public:
	class UUserWidget*                                 WidgetBP;                                                 // 0x0108(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	bool                                               bHideCategory;                                            // 0x0110(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FString                                     SearchStr;                                                // 0x0108(0x0010) (ZeroConstructor)
...
{
public:
	TEnumAsByte<enum EBlockyAccessType>                Access;                                                   // 0x0108(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsCustomVar;                                              // 0x0109(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x16];                                      // 0x010A(0x0016) MISSED OFFSET
...
{
public:
	class UBrushData*                                  SlotBrush;                                                // 0x0418(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  TailBrush;                                                // 0x0420(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1E8];                                     // 0x0428(0x01E8) MISSED OFFSET
...
// 0x07B8 (0x0DC8 - 0x0610)
class UBlockyTimer : public UExeSequencerBase
{
public:
	unsigned char                                      UnknownData00[0x7B0];                                     // 0x0610(0x07B0) MISSED OFFSET
	class UBrushData*                                  IconBrush;                                                // 0x0DC0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	class UBlockyTimer*                                HostTimer;                                                // 0x01F8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
// 0x0298 (0x06B0 - 0x0418)
class UCallFunction : public UExecuteable
{
public:
	unsigned char                                      UnknownData00[0x20];                                      // 0x0418(0x0020) MISSED OFFSET
	class UBrushData*                                  IconBrush;                                                // 0x0438(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  SelectionBG;                                              // 0x0440(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData01[0x268];                                     // 0x0448(0x0268) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0xF0];                                      // 0x0418(0x00F0) MISSED OFFSET
	class UBlockBase*                                  CandidateParentBlock;                                     // 0x0508(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	unsigned char                                      UnknownData00[0x340];                                     // 0x0610(0x0340) MISSED OFFSET
	class UBrushData*                                  IconBrush;                                                // 0x0950(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	class UCustomConfig*                               Config;                                                   // 0x0420(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGuid                                       ConfigName;                                               // 0x0428(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	class UBrushData*                                  BrushBGSelected;                                          // 0x0438(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  IconBrush;                                                // 0x0440(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  BrushBG;                                                  // 0x0448(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	class UCustomConfig*                               Config;                                                   // 0x0628(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGuid                                       ConfigName;                                               // 0x0630(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	class UBrushData*                                  IconBrush;                                                // 0x0640(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  BrushBG;                                                  // 0x0648(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	struct FText                                       Name;                                                     // 0x0418(0x0018)
...
public:
	...
	class UCustomConfig*                               Config;                                                   // 0x0470(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGuid                                       ConfigName;                                               // 0x0478(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	class UBrushData*                                  IconBrush;                                                // 0x0488(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  BrushBG;                                                  // 0x0490(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	class UCustomConfig*                               Config;                                                   // 0x0200(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGuid                                       ConfigName;                                               // 0x0208(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	class UBrushData*                                  BrushBGSelected;                                          // 0x0218(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  BrushBG;                                                  // 0x0220(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData01[0x20];                                      // 0x0228(0x0020) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x1A0];                                     // 0x0610(0x01A0) MISSED OFFSET
	class UCustomConfig*                               Config;                                                   // 0x07B0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGuid                                       ConfigName;                                               // 0x07B8(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	class UBrushData*                                  IconBrush;                                                // 0x07C8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  BrushBG;                                                  // 0x07D0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
// 0x0318 (0x0928 - 0x0610)
class UDoNum : public UExeSequencerBase
{
public:
	unsigned char                                      UnknownData00[0x310];                                     // 0x0610(0x0310) MISSED OFFSET
	class UBrushData*                                  IconBrush;                                                // 0x0920(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	TArray<struct FBlockPreviewBrush>                  Rects;                                                    // 0x0418(0x0010) (ZeroConstructor)
	class UBrushData*                                  DisableIconBrush;                                         // 0x0428(0x0008) (ZeroConstructor, IsPlainOldData)
...
// 0x04C0 (0x0AD0 - 0x0610)
class UForEach : public UExeSequencerBase
{
public:
	unsigned char                                      UnknownData00[0x4B8];                                     // 0x0610(0x04B8) MISSED OFFSET
	class UBrushData*                                  IconBrush;                                                // 0x0AC8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	class UClass*                                      BlockClass;                                               // 0x0128(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0130(0x0010) MISSED OFFSET
	TArray<struct FFunctionParameter>                  Parameters;                                               // 0x0140(0x0010) (ZeroConstructor)
	TArray<struct FFunctionParameter>                  AddEventParameters;                                       // 0x0150(0x0010) (ZeroConstructor)
	TMap<struct FString, struct FString>               ModuleRequires;                                           // 0x0160(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x80];                                      // 0x01B0(0x0080) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x198];                                     // 0x01F8(0x0198) MISSED OFFSET
	class UBrushData*                                  BrushBGSelected;                                          // 0x0390(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	class UIfElseCondition*                            IfCondition;                                              // 0x0418(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class UIfElseCondition*>                    ElseConditions;                                           // 0x0420(0x0010) (ZeroConstructor)
...
{
public:
	class UIfElse*                                     ParentIfElse;                                             // 0x0610(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1E0];                                     // 0x0618(0x01E0) MISSED OFFSET
...
// 0x0320 (0x0738 - 0x0418)
class UInsertArrayElement : public UExecuteable
{
public:
	unsigned char                                      UnknownData00[0x320];                                     // 0x0418(0x0320) MISSED OFFSET
...
{
public:
	class UBrushData*                                  BrushBGSelected;                                          // 0x01F8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	unsigned char                                      UnknownData00[0x320];                                     // 0x0200(0x0320) MISSED OFFSET
...
// 0x0498 (0x0698 - 0x0200)
class ULogicCompare : public ULogicBase
{
public:
	unsigned char                                      UnknownData00[0x498];                                     // 0x0200(0x0498) MISSED OFFSET
...
// 0x0188 (0x0388 - 0x0200)
class ULogicNot : public ULogicBase
{
public:
	unsigned char                                      UnknownData00[0x188];                                     // 0x0200(0x0188) MISSED OFFSET
...
// 0x0980 (0x0F90 - 0x0610)
class UNumFromTo : public UExeSequencerBase
{
public:
	unsigned char                                      UnknownData00[0x7B8];                                     // 0x0610(0x07B8) MISSED OFFSET
	class UBrushData*                                  IconBrush;                                                // 0x0DC8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1C0];                                     // 0x0DD0(0x01C0) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x1A8];                                     // 0x0418(0x01A8) MISSED OFFSET
...
public:
	...
	struct FString                                     CustomVarType;                                            // 0x00F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<unsigned char>                              CustomExtraData;                                          // 0x0108(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      DynamicType;                                              // 0x0118(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               Exclude;                                                  // 0x0119(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1C6];                                     // 0x011A(0x01C6) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x310];                                     // 0x0418(0x0310) MISSED OFFSET
	class UBrushData*                                  IconBrush;                                                // 0x0728(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  SelectionBG;                                              // 0x0730(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
// 0x0320 (0x0518 - 0x01F8)
class UStringAppend : public UBlockBase
{
public:
	unsigned char                                      UnknownData00[0x320];                                     // 0x01F8(0x0320) MISSED OFFSET
...
// 0x0190 (0x07A0 - 0x0610)
class UWhile : public UExeSequencerBase
{
public:
	unsigned char                                      UnknownData00[0x188];                                     // 0x0610(0x0188) MISSED OFFSET
	class UBrushData*                                  IconBrush;                                                // 0x0798(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
