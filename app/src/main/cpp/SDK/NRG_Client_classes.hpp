...
public:
	...
	static void HelpshiftShowSingleFAQWithInfo(const struct FString& publishID, TMap<struct FString, struct FString> hsMetaInfo, const struct FString& ExtraTags, TMap<struct FString, struct FString> hsIssueFields);
	static void HelpshiftShowFAQsWithInfo(TMap<struct FString, struct FString> hsMetaInfo, const struct FString& ExtraTags, TMap<struct FString, struct FString> hsIssueFields);
	static void HelpshiftShowFAQs();
	static void HelpshiftShowConversionWithInfo(TMap<struct FString, struct FString> hsMetaInfo, TMap<struct FString, struct FString> hsIssueFields);
...
{
public:
	bool                                               bInitInGame;                                              // 0x0090(0x0001) (BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0091(0x0007) MISSED OFFSET
	TMap<int, unsigned char>                           SaveTypeMap;                                              // 0x0098(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	TMap<int, struct FUIElemLayoutDetail>              CachedLayoutDetailMap;                                    // 0x00E8(0x0050) (BlueprintVisible, ZeroConstructor, Transient)
	unsigned char                                      UnknownData01[0xD0];                                      // 0x0138(0x00D0) MISSED OFFSET
	...
	void UnregisterCustomLayoutChange(class UUAECustomizePanel* InCustomizePanel);
	void RegisterCustomLayoutChange(class UUAECustomizePanel* InCustomizePanel);
	...
	void BroadcastCustomLayoutChangeForAll(bool bNotCheck);
	void BroadcastCustomLayoutChangeBySaveType(unsigned char InSaveType, bool bNotCheck);
	void BroadcastCustomLayoutChangeByCustomType(int InCustomType, bool bNotCheck);
	void AddInvalidCustomTypeCache(int InCustomType);
};


// Class Client.CustomPanelProxy
// 0x0130 (0x0158 - 0x0028)
class UCustomPanelProxy : public UObject
{
public:
	TWeakObjectPtr<class UUAECustomizePanel>           OwnerPanel;                                               // 0x0028(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	bool                                               bIsFlashEffect;                                           // 0x0030(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0031(0x0007) MISSED OFFSET
	struct FSlateBrush                                 SelectedImageOriginalSlateBrush;                          // 0x0038(0x00B8) (BlueprintVisible)
	class UMaterialInterface*                          SelectedImageCircularFlashEffectMaterial;                 // 0x00F0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          SelectedImageSquareFlashEffectMaterial;                   // 0x00F8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TWeakObjectPtr<class UWidget>                      ParentWidget;                                             // 0x0100(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TMap<struct FString, TWeakObjectPtr<class UWidget>> NamedWidgetCache;                                         // 0x0108(0x0050) (ExportObject, ZeroConstructor)

	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class Client.CustomPanelProxy");
		return pStaticClass;
	}
	...
	void SetOwnerPanel(class UUAECustomizePanel* InPanel);
	...
	struct FMargin GetScreenMargin();
	class UWidget* GetParentWidget();
	class UWidget* GetNamedWidgetFromOwner(const struct FString& Prefix);
	class UBorder* GetBorder_RealSize();
	struct FMargin CalculateLimitPosition();
};
...
public:
	...
	struct FScriptDelegate                             OnPermissionResultEvent;                                  // 0x0B18(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnDeviceRotationChangedEvent;                             // 0x0B28(0x0010) (ZeroConstructor, InstancedReference)
	struct FString                                     CurrentMapName;                                           // 0x0B38(0x0010) (ZeroConstructor)
...
{
public:
	TArray<struct FDecalParameter>                     DecalParams;                                              // 0x0340(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	class UTextureRenderTarget2D*                      DecalRenderTarget;                                        // 0x0350(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class ADecalBakingActor*                           DecalBakingActor;                                         // 0x0358(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                RTSize;                                                   // 0x0360(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UStaticMeshComponent*                        stMesh;                                                   // 0x0448(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	TArray<struct FLobbyBgMatData>                     matWaitToChangeList;                                      // 0x0450(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
...
{
public:
	struct FScriptMulticastDelegate                    OnCaptureError;                                           // 0x0448(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FString                                     PicturePath;                                              // 0x0458(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FVector2D                                   RTSize;                                                   // 0x0468(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               AlphaFullCorrect;                                         // 0x0470(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               AlphaReverse;                                             // 0x0471(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0472(0x0002) MISSED OFFSET
	float                                              AlphaRate;                                                // 0x0474(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               AlphaChannelEnable;                                       // 0x0478(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               GammaCorrect;                                             // 0x0479(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               HSSave;                                                   // 0x047A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               ClearDrawRT;                                              // 0x047B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x047C(0x0004) MISSED OFFSET
	class UMaterialInstance*                           WriteMat;                                                 // 0x0480(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UTextureRenderTarget2D*                      DrawRT;                                                   // 0x0488(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneCaptureComponent2D*                    Capture2D;                                                // 0x0490(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class USceneCaptureComponent2D*                    AlphaCapture2D;                                           // 0x0498(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	float                                              ScreenWidth;                                              // 0x04A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ScreenHeight;                                             // 0x04A4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   AABBBoxLeftPoint;                                         // 0x04A8(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector2D                                   AABBBoxRightPoint;                                        // 0x04B0(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
...
{
public:
	class UGameBusinessManager*                        pManager;                                                 // 0x0460(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0468(0x0002) MISSED OFFSET
	bool                                               bClearSourceCodeAfterInitialized;                         // 0x046A(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x45];                                      // 0x046B(0x0045) MISSED OFFSET
...
public:
	...
	static struct FString MakePictureUncompress(bool isShowUI);
...
public:
	...
	static void RestartPuffer(class UGameFrontendHUD* GameFrontendHUD, bool needCheck, int maxDownloadsPerTask, int maxDownTask, int maxDownloadSpeed, bool useOldInterface, bool removeOldWhenUpdate, int versionType, const struct FString& InDownloadFuncDict, int InDnsType, int InDownloadStage);
	...
	static void ReInitializePuffer(class UGameFrontendHUD* GameFrontendHUD, bool needCheck, int maxDownloadsPerTask, int maxDownTask, int maxDownloadSpeed, bool useOldInterface, bool removeOldWhenUpdate, int versionType, const struct FString& InDownloadFuncDict, int InDnsType, int InDownloadStage);
	...
	static void InitializePuffer(class UGameFrontendHUD* GameFrontendHUD, bool needCheck, int maxDownloadsPerTask, int maxDownTask, int maxDownloadSpeed, bool useOldInterface, bool removeOldWhenUpdate, int versionType, const struct FString& InDownloadFuncDict, int InDnsType, int InDownloadStage);
	...
	static void HttpDnsSetOpenid(const struct FString& InOpenid);
	static void HttpDnsInit(const struct FString& InAppId, bool InIsDebug, int InTimeout);
	...
	static struct FString ConvertDataToHEX(const struct FString& CompressedData, int CompressedSize);
	...
	static void AddKnownMissingPackage(class UObject* BindObj, struct FString* PackageName);
...
public:
	...
	uint32_t                                           openVoiceSDKLog;                                          // 0x00C0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	...
	unsigned char                                      UnknownData03[0x70];                                      // 0x00D8(0x0070) MISSED OFFSET
	...
	struct FScriptDelegate                             BeforeOperation;                                          // 0x0178(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseMicSuccess;                                          // 0x0188(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OpenSpeakerFail;                                          // 0x0198(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OpenSpeakerSuccess;                                       // 0x01A8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseSpeakerFail;                                         // 0x01B8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseSpeakerSuccess;                                      // 0x01C8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinRoomFail;                                             // 0x01D8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinRoomNotify;                                           // 0x01E8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             QuitRoomNotify;                                           // 0x01F8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinLbsRoomNotify;                                        // 0x0208(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             QuitLbsRoomNotify;                                        // 0x0218(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RoomStatusUpdatedNotify;                                  // 0x0228(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             SetAppInfoSuccess;                                        // 0x0238(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             SetAppInfoFail;                                           // 0x0248(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             GetReconnectInfo;                                         // 0x0258(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ImSpeakingNotify;                                         // 0x0268(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             TestMicFail;                                              // 0x0278(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             TestMicSuccess;                                           // 0x0288(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             QuitRoomFail;                                             // 0x0298(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             DownLoadFileNotify;                                       // 0x02A8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             UploadFileNotify;                                         // 0x02B8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             KwsNotify;                                                // 0x02C8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ApplyMessageKeyNotify;                                    // 0x02D8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             MemberIsSpeakingNotify;                                   // 0x02E8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             LbsMemberIsSpeakingNotify;                                // 0x02F8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMuteSwitchResult;                                       // 0x0308(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ReportVoiceTimeToServer;                                  // 0x0318(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RecordSuccess;                                            // 0x0328(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RecordFail;                                               // 0x0338(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             UploadSuccess;                                            // 0x0348(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             UploadFail;                                               // 0x0358(0x0010) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             OnRoomMemeberInfoDelegate;                                // 0x0408(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData04[0x88];                                      // 0x0418(0x0088) MISSED OFFSET
	struct FScriptDelegate                             OnDeliverDataCallback;                                    // 0x04A0(0x0010) (ZeroConstructor, InstancedReference)
	...
	int EnableRSTSSubtitle(bool InEnable, int InSrcLang);
