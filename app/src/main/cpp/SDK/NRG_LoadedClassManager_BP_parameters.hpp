...
struct ULoadedClassManager_BP_C_LoadEffectItemBPTable_Params
{
...
struct ULoadedClassManager_BP_C_LoadBPTableData_Params
{
	struct FString                                     BPTableName;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor)
