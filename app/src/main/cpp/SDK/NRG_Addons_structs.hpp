...
enum class EBioVehicleState : uint8_t
{
	...
	EBioVehicleState____MAX        = 11,
	EBioVehicleState__EBioVehicleState_MAX = 12
};
...
enum class EOffsetRootBoneMode : uint8_t
{
	...
	EOffsetRootBoneMode__Release   = 2,
	EOffsetRootBoneMode__EOffsetRootBoneMode_MAX = 3
};
...
// Enum Addons.EUAECheckSkillTokenType
enum class EUAECheckSkillTokenType : uint8_t
{
	EUAECheckSkillTokenType__EUAECheckSkillTokenType_Any = 0,
	EUAECheckSkillTokenType__EUAECheckSkillTokenType_NotAny = 1,
	EUAECheckSkillTokenType__EUAECheckSkillTokenType_All = 2,
	EUAECheckSkillTokenType__EUAECheckSkillTokenType_NotAll = 3,
	EUAECheckSkillTokenType__EUAECheckSkillTokenType_MAX = 4
};
...
enum class EUAECheckCastingSkillType : uint8_t
{
	...
	EUAECheckCastingSkillType__EUAECheckCastingSkillType_MatchAll = 4,
	EUAECheckCastingSkillType__EUAECheckCastingSkillType_MAX = 5
};
...
struct FAnimNode_OffsetRootBone : public FAnimNode_Base
{
	...
	class UWorld*                                      CachedWorldContext;                                       // 0x00F0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
struct FAnimNode_SyncBlendSpacePlayerSafety : public FAnimNode_BlendSpacePlayer
{
	...
	class UAnimInstance*                               LinkedAnimInstanceLastFrame;                              // 0x0140(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class UProperty*>                           PropagatedProperties;                                     // 0x0148(0x0010) (ZeroConstructor)
