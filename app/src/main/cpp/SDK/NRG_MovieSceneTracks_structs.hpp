...
struct FMovieScene3DAttachSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	EAttachmentRule                                    AttachmentLocationRule;                                   // 0x0038(0x0001) (ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AttachmentRotationRule;                                   // 0x0039(0x0001) (ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AttachmentScaleRule;                                      // 0x003A(0x0001) (ZeroConstructor, IsPlainOldData)
	EDetachmentRule                                    DetachmentLocationRule;                                   // 0x003B(0x0001) (ZeroConstructor, IsPlainOldData)
	EDetachmentRule                                    DetachmentRotationRule;                                   // 0x003C(0x0001) (ZeroConstructor, IsPlainOldData)
	EDetachmentRule                                    DetachmentScaleRule;                                      // 0x003D(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FMovieScene3DPathSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      bFollow : 1;                                              // 0x009A(0x0001)
	unsigned char                                      bReverse : 1;                                             // 0x009A(0x0001)
	unsigned char                                      bForceUpright : 1;                                        // 0x009A(0x0001)
	unsigned char                                      bUseConstantVelocity : 1;                                 // 0x009A(0x0001)
...
struct FMovieScene3DTransformTemplateData
{
	...
	bool                                               bIgnoreGlobalTransform;                                   // 0x0468(0x0001) (ZeroConstructor, IsPlainOldData)
...
// 0x0470 (0x0488 - 0x0018)
struct FMovieSceneComponentTransformSectionTemplate : public FMovieSceneEvalTemplate
{
	struct FMovieScene3DTransformTemplateData          TemplateData;                                             // 0x0018(0x0470)
};
...
{
	struct FMovieSceneAudioSectionTemplateData         AudioData;                                                // 0x0018(0x0140)
};
...
{
	struct FRichCurve                                  Curves[0x4];                                              // 0x0040(0x0070)
...
struct FMovieScenePrimitiveMaterialTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
	struct FStringCurve                                BoolCurve;                                                // 0x0020(0x0078)
};
...
{
	struct FMovieScene3DTransformTemplateData          TemplateData;                                             // 0x0040(0x0470)
};
...
struct FMovieSceneVectorPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	EMovieSceneBlendType                               BlendType;                                                // 0x0204(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FMovieSceneIntegerPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	EMovieSceneBlendType                               BlendType;                                                // 0x00B0(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	struct FVector                                     Vector;                                                   // 0x004C(0x000C) (Edit, IsPlainOldData)
};
...
{
	struct FVector2D                                   Vector;                                                   // 0x004C(0x0008) (Edit, IsPlainOldData)
