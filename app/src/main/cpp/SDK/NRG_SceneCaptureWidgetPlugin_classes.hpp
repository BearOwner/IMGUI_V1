...
{
public:
	class ASceneCaptureCameraActor*                    OwnerCameraActor;                                         // 0x09B0(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class UWidgetCaptureComponent2D*                   SceneCaptureComponent;                                    // 0x09D0(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
