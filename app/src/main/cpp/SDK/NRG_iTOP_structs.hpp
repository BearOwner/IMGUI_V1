...
// ScriptStruct iTOP.IMSDKQRCodeStatusResult
// 0x0018 (0x0058 - 0x0040)
struct FIMSDKQRCodeStatusResult : public FiTOPResult
{
	int                                                status;                                                   // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0044(0x0004) MISSED OFFSET
	struct FString                                     Channel;                                                  // 0x0048(0x0010) (ZeroConstructor)
};

// ScriptStruct iTOP.IMSDKQRCodeResult
// 0x0040 (0x0080 - 0x0040)
struct FIMSDKQRCodeResult : public FiTOPResult
{
	struct FString                                     codeId;                                                   // 0x0040(0x0010) (ZeroConstructor)
	struct FString                                     randStr;                                                  // 0x0050(0x0010) (ZeroConstructor)
	int                                                nextAt;                                                   // 0x0060(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                expireAt;                                                 // 0x0064(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                createAt;                                                 // 0x0068(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                queryInterval;                                            // 0x006C(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     codeData;                                                 // 0x0070(0x0010) (ZeroConstructor)
};

// ScriptStruct iTOP.IMSDKWebVerifyResult
// 0x0010 (0x0050 - 0x0040)
struct FIMSDKWebVerifyResult : public FiTOPResult
{
	struct FString                                     captcha;                                                  // 0x0040(0x0010) (ZeroConstructor)
};
...
struct FIMSDKUnifiedAccountResult : public FiTOPResult
{
	...
	int                                                sendType;                                                 // 0x00E0(0x0004) (ZeroConstructor, IsPlainOldData)
