...
public:
	...
	unsigned char                                      UnknownData06[0x938];                                     // 0x03D0(0x0938) MISSED OFFSET
	class USCoronaClientData*                          SecurityCoronaLabClientDataPointer;                       // 0x0D08(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x68];                                      // 0x0D10(0x0068) MISSED OFFSET
	bool                                               bMHActive;                                                // 0x0D78(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0xAF];                                      // 0x0D79(0x00AF) MISSED OFFSET
	TMap<int, int>                                     FFItemIDMap;                                              // 0x0E28(0x0050) (ZeroConstructor)
	TMap<int, int>                                     FFWeaponItemIDMap;                                        // 0x0E78(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData09[0x1C];                                      // 0x0EC8(0x001C) MISSED OFFSET
	int                                                ReceivedRotationModifiedCount;                            // 0x0EE4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ReceivedTranslationModifiedCount;                         // 0x0EE8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ReceivedScale3DModifiedCount;                             // 0x0EEC(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<int>                                        LastInvalidIndexListInPakLite;                            // 0x0EF0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData10[0x8];                                       // 0x0F00(0x0008) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnServerReceiveInvalidFilesInPakLiteDelegate;             // 0x0F08(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData11[0xE8];                                      // 0x0F18(0x00E8) MISSED OFFSET
	float                                              TouchScreenActiveTimeRatioThreshold;                      // 0x1000(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x4];                                       // 0x1004(0x0004) MISSED OFFSET
	float                                              MouTa;                                                    // 0x1008(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                BandaCountThreshold;                                      // 0x100C(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bEnableBandCount;                                         // 0x1010(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x3];                                       // 0x1011(0x0003) MISSED OFFSET
	float                                              IntervalThreshold1;                                       // 0x1014(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                HongThreshold;                                            // 0x1018(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              NovoThreshold;                                            // 0x101C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x40];                                      // 0x1020(0x0040) MISSED OFFSET
	int                                                MaxCountOfPlayerHistoryLocationToDetectCamouflage;        // 0x1060(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData15[0xC];                                       // 0x1064(0x000C) MISSED OFFSET
	float                                              MinDistanceToDetectCamouflage;                            // 0x1070(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData16[0x8];                                       // 0x1074(0x0008) MISSED OFFSET
	float                                              LastAbnormalJumpTime;                                     // 0x107C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              LastAbnormalJumpVelocity;                                 // 0x1080(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData17[0x4];                                       // 0x1084(0x0004) MISSED OFFSET
