...
enum class EBattleItemDropReason : uint8_t
{
	...
	EBattleItemDropReason__WeaponExchangeDropAttach = 10,
	EBattleItemDropReason__EBattleItemDropReason_MAX = 11
};
...
enum class EBattleItemAdditionalDataType : uint8_t
{
	...
	EBattleItemAdditionalDataType__ExtraData01 = 30,
	EBattleItemAdditionalDataType__ExtraData02 = 31,
	EBattleItemAdditionalDataType__OwnerInfo = 32,
	EBattleItemAdditionalDataType__DropPlanInfo = 33,
	EBattleItemAdditionalDataType__PveAffix = 34,
	EBattleItemAdditionalDataType__ShapeInfo = 35,
	EBattleItemAdditionalDataType__GunPoint = 36,
	EBattleItemAdditionalDataType__Grip = 37,
	EBattleItemAdditionalDataType__Magazine = 38,
	EBattleItemAdditionalDataType__Gunstock = 39,
	EBattleItemAdditionalDataType__OpticalSight = 40,
	EBattleItemAdditionalDataType__MasterGun = 41,
	EBattleItemAdditionalDataType__Ammo = 42,
	EBattleItemAdditionalDataType__Pendant = 43,
	EBattleItemAdditionalDataType__AngledOpticalSight = 44,
	EBattleItemAdditionalDataType__ACCore = 45,
	EBattleItemAdditionalDataType__Bezel = 46,
	EBattleItemAdditionalDataType__GunLock = 47,
	EBattleItemAdditionalDataType__TacticalAttach = 48,
	EBattleItemAdditionalDataType__EBattleItemAdditionalDataType_MAX = 49
};
...
enum class EAnimLayerType : uint8_t
{
	EAnimLayer_Char                = 0,
	EAnimLayer_Avatar              = 1,
	EAnimLayer_AvatarAdditive      = 2,
	EAnimLayer_Weapon              = 3,
	EAnimLayer_WeaponAdditive      = 4,
	EAnimLayer_WeaponAdditive2     = 5,
	EAnimLayer_WeaponDIYAvatar     = 6,
	EAnimLayer_WeaponDIYAvatarAdditive = 7,
	EAnimLayer_Skill               = 8,
	EAnimLayer_SkillAdditive       = 9,
	EAnimLayer_Skill2              = 10,
	EAnimLayer_Max                 = 11
};
...
enum class EBattleItemPickupReason : uint8_t
{
	...
	EBattleItemPickupReason__StorageBoxToBag = 7,
	EBattleItemPickupReason__EBattleItemPickupReason_MAX = 8
};


// Enum Basic.EAttrModifyRecordType
enum class EAttrModifyRecordType : uint8_t
{
	Record_None                    = 0,
	SetValue_Respone               = 1,
	SetValue_OnRepModSim           = 2,
	SetValue_CaculateAttr1         = 3,
	SetValue_CaculateAttr2         = 4,
	SetValue_ClampAttr             = 5,
	SetValue_InterfaceSet          = 6,
	SetValue_Lua                   = 7,
	Remove_DisableAttr             = 8,
	Remove_RemoveDynamic           = 9,
	Remove_OnRepDynamic            = 10,
	Modify_EnableAttrIndex         = 11,
	Modify_AddDynamic              = 12,
	EAttrModifyRecordType_MAX      = 13
};
...
// Enum Basic.EItemAttrs
enum class EItemAttrs : uint8_t
{
	EItemAttrs__ItemAttr_CannotManualDrop = 0,
	EItemAttrs__ItemAttr_RespawnNotDrop = 1,
	EItemAttrs__ItemAttr_TransformNotDrop = 2,
	EItemAttrs__ItemAttr_NotAddInTombBox = 3,
	EItemAttrs__ItemAttr_CanCarryInBattle = 4,
	EItemAttrs__ItemAttr_CannotMoveToVehicleBackpack = 5,
	EItemAttrs__ItemAttr_MAX       = 6
};
...
enum class EBattleItemPickupRule : uint8_t
{
	...
	EBattleItemPickupRule__AllCanSeeSelfCanPickUp = 4,
	EBattleItemPickupRule__None    = 5,
	EBattleItemPickupRule__EBattleItemPickupRule_MAX = 6
};
...
{
	EDeviceLevel__DeviceLevel_Low  = 0,
	EDeviceLevel__DeviceLevel_Middle = 1,
	EDeviceLevel__DeviceLevel_Hight = 2,
	EDeviceLevel__DeviceLevel_MAX  = 3
};
...
enum class EBuffEnabledRole : uint8_t
{
	...
	EBuffEnabledRole__Role_AutonomousAuthority = 5,
	EBuffEnabledRole__Role_AuthoritySimulated = 6,
	EBuffEnabledRole__EBuffEnabledRole_MAX = 7
};
...
enum class EBuffConditionInitializeType : uint8_t
{
	...
	EBuffConditionInitializeType__DisabledWhenFalse = 2,
	EBuffConditionInitializeType__EBuffConditionInitializeType_MAX = 3
};
...
// Enum Basic.EBuffShowInUIType
enum class EBuffShowInUIType : uint8_t
{
	EBuffShowInUIType__None        = 0,
	EBuffShowInUIType__DurationTime = 1,
	EBuffShowInUIType__CDTime      = 2,
	EBuffShowInUIType__EBuffShowInUIType_MAX = 3
};
...
enum class EBuffTargetType : uint8_t
{
	...
	EBuffTargetType__AllWeapons    = 6,
	EBuffTargetType__EBuffTargetType_MAX = 7
};
...
enum class EMultiSkillHandleType : uint8_t
{
	...
	EMultiSkillHandleType__RefreshOlder = 3,
	EMultiSkillHandleType__Coexist = 4,
...
enum class EMultiCauserHandleType : uint8_t
{
	...
	EMultiCauserHandleType__RefreshOlder = 3,
	EMultiCauserHandleType__Coexist = 4,
...
enum class EBuffTargetSourceType : uint8_t
{
	...
	EBuffTargetSourceType__SelfAndAreaOfTeammate = 5,
	EBuffTargetSourceType__EBuffTargetSourceType_MAX = 6
};
...
// Enum Basic.ETickOptimizationAnimUROMode
enum class ETickOptimizationAnimUROMode : uint8_t
{
	ETickOptimizationAnimUROMode__ScreenSize = 0,
	ETickOptimizationAnimUROMode__LOD = 1,
	ETickOptimizationAnimUROMode__MinLOD = 2,
	ETickOptimizationAnimUROMode__ETickOptimizationAnimUROMode_MAX = 3
};


// Enum Basic.ETickOptimizationDistanceMode
enum class ETickOptimizationDistanceMode : uint8_t
{
	ETickOptimizationDistanceMode__None = 0,
	ETickOptimizationDistanceMode__Sphere = 1,
	ETickOptimizationDistanceMode__ETickOptimizationDistanceMode_MAX = 2
};
...
struct FBattleItemAdditionalData
{
	...
	uint64_t                                           Uint64Data;                                               // 0x0020(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
struct FBattleItemFeatureData
{
	...
	int                                                ItemSubType;                                              // 0x002C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
};
...
struct FBattleItemData : public FItemData
{
	...
	int64_t                                            Priority;                                                 // 0x0078(0x0008) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	struct FBattleItemFeatureData                      FeatureData;                                              // 0x0080(0x0030) (BlueprintVisible)
	TArray<struct FItemAssociation>                    Associations;                                             // 0x00B0(0x0010) (BlueprintVisible, ZeroConstructor)
};
...
struct FClientBaseInfo
{
	...
	TArray<int>                                        MrpcsData;                                                // 0x00A0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x8];                                       // 0x00B0(0x0008) MISSED OFFSET
	TMap<int, struct FString>                          AdvConfig;                                                // 0x00B8(0x0050) (ZeroConstructor)
	TMap<struct FString, class UTexture2D*>            AdvTextureList;                                           // 0x0108(0x0050) (ZeroConstructor)
};
...
struct FAttrDesc
{
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	float                                              CurValue;                                                 // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
};

// ScriptStruct Basic.AttrModifyRecordDetail
// 0x0010
struct FAttrModifyRecordDetail
{
	float                                              PreModifyValue;                                           // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              AfterModifyValue;                                         // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              WorldTime;                                                // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ModifyType;                                               // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
};

// ScriptStruct Basic.AttrModifyRecordDetails
// 0x0028
struct FAttrModifyRecordDetails
{
	struct FString                                     ModifyDesc;                                               // 0x0000(0x0010) (ZeroConstructor)
	int                                                NextIndex;                                                // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0014(0x0004) MISSED OFFSET
	TArray<struct FAttrModifyRecordDetail>             Data;                                                     // 0x0018(0x0010) (ZeroConstructor)
};

// ScriptStruct Basic.AttrModifyRecordItem
// 0x0028
struct FAttrModifyRecordItem
{
	struct FAttrDesc                                   AttrDesc;                                                 // 0x0000(0x0018)
	TArray<struct FAttrModifyRecordDetails>            DetailsArray;                                             // 0x0018(0x0010) (ZeroConstructor)
};
...
{
	int                                                AttrId;                                                   // 0x0000(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FString                                     AttrName;                                                 // 0x0008(0x0010) (BlueprintVisible, ZeroConstructor)
	EAttrVariableType                                  AttrVariableType;                                         // 0x0018(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               HasReplicatedTag;                                         // 0x0019(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1E];                                      // 0x001A(0x001E) MISSED OFFSET
};
...
struct FBPClassItem
{
	...
	TMap<struct FString, struct FString>               BPClassModOverridePath;                                   // 0x0060(0x0050) (Edit, ZeroConstructor, DisableEditOnInstance)
};
...
{
	TMap<struct FString, struct FString>               BPClassModOverridePath;                                   // 0x0000(0x0050) (Edit, ZeroConstructor, DisableEditOnInstance)
};
...
// ScriptStruct Basic.ConditionIndex
// 0x0004
...
// ScriptStruct Basic.BuffCheckConditionWrapperItem
// 0x0008
...
struct FClientSyncBrief
{
	...
	unsigned char                                      LayerMax;                                                 // 0x0005(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      Level;                                                    // 0x0006(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x0007(0x0001) MISSED OFFSET
	...
	float                                              Duration;                                                 // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              EndTime;                                                  // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0024(0x0004) MISSED OFFSET
	TArray<float>                                      CDDataArray;                                              // 0x0028(0x0010) (ZeroConstructor)
};
...
{
	struct FClientSyncBrief                            Unit;                                                     // 0x0000(0x0038)
	bool                                               bMarkDelete;                                              // 0x0038(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FBuffInstInfo
{
	...
	TWeakObjectPtr<class AActor>                       Causer;                                                   // 0x0014(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
};
...
// ScriptStruct Basic.TickOptimizationTickSettings
// 0x0008
...
// ScriptStruct Basic.TableNameToName
// 0x0048
struct FTableNameToName
{
	struct FName                                       tableName;                                                // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FName                                       Path;                                                     // 0x0018(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       PathHigh;                                                 // 0x0020(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       LobbyPath;                                                // 0x0028(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       LobbyPathHigh;                                            // 0x0030(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       WrapperPath;                                              // 0x0038(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       Custom1;                                                  // 0x0040(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
{
	TArray<struct FPickupFirstCount>                   TaskPickFirst;                                            // 0x0000(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	int                                                FlarePistolID;                                            // 0x0090(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0094(0x0004) MISSED OFFSET
	TArray<int>                                        SideMirrorList;                                           // 0x0098(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        MirrorList;                                               // 0x00A8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	int                                                ViscidityBomb;                                            // 0x00B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                GrenadeZombie;                                            // 0x00BC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                DefaultMedicineNum;                                       // 0x00C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                helmetSubType;                                            // 0x00C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                armorSubType;                                             // 0x00C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                ScoreItemSubType;                                         // 0x00CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                SpecialNoDropItemSubType;                                 // 0x00D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                IceDrinkItemSubType;                                      // 0x00D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                IsAutoPickUpTaskSubType;                                  // 0x00D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                CapacityThreshold;                                        // 0x00DC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                GlideSubType;                                             // 0x00E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                ParachuteItemSubType;                                     // 0x00E4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                revivalCardID;                                            // 0x00E8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                SnowManID;                                                // 0x00EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              revivalCardValidTime;                                     // 0x00F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x00F4(0x0004) MISSED OFFSET
	TArray<int>                                        firewoodPriority;                                         // 0x00F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        meatPriority;                                             // 0x0108(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        UAVList;                                                  // 0x0118(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        ElectricityList;                                          // 0x0128(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        ToUseInBackpackSubList;                                   // 0x0138(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        ToUseInBackpackIDList;                                    // 0x0148(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        notExtractItemIDList;                                     // 0x0158(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
};
...
struct FPickupSetting
{
	...
	int                                                LimitViscidityBomb;                                       // 0x0018(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LimitAntidote;                                            // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LimitBatteryChip;                                         // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LimitGameCoin;                                            // 0x0024(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               AutoPickupPistol;                                         // 0x0028(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               AutoPickupLevel3Backpack;                                 // 0x0029(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               AutoPickupSideMirror;                                     // 0x002A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x002B(0x0001) MISSED OFFSET
	int                                                LimitSniper2X;                                            // 0x002C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LimitSniper3X;                                            // 0x0030(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LimitSniper4X;                                            // 0x0034(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LimitSniper6X;                                            // 0x0038(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LimitSniper8X;                                            // 0x003C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               AutoPickupSkillProps;                                     // 0x0040(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0041(0x0003) MISSED OFFSET
	int                                                LimitSkillProps;                                          // 0x0044(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LimitSnowMan;                                             // 0x0048(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               AutoPickMirror;                                           // 0x004C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x004D(0x0003) MISSED OFFSET
	int                                                AutoPickClipType;                                         // 0x0050(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0054(0x0004) MISSED OFFSET
	TMap<int, int>                                     LimitDrugMap;                                             // 0x0058(0x0050) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TMap<int, int>                                     LimitThrowObjMap;                                         // 0x00A8(0x0050) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TMap<int, int>                                     LimitMultipleMirrorMap;                                   // 0x00F8(0x0050) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TMap<int, int>                                     LimitFixConsumeItemMap;                                   // 0x0148(0x0050) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TMap<int, int>                                     LimitSeasonItemMap;                                       // 0x0198(0x0050) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
};
...
struct FSTBuffInstancedItem
{
	...
	TArray<float>                                      CDDataArray;                                              // 0x0028(0x0010) (ZeroConstructor)
	TWeakObjectPtr<class AActor>                       Causer;                                                   // 0x0038(0x0008) (ZeroConstructor, IsPlainOldData)
	TWeakObjectPtr<class AActor>                       Owner;                                                    // 0x0040(0x0008) (ZeroConstructor, IsPlainOldData)
	TWeakObjectPtr<class USTBuff>                      Buff;                                                     // 0x0048(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UActorComponent>              OwnerSystem;                                              // 0x0050(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	int                                                CauseSkillID;                                             // 0x0058(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              LastSyncClientTime;                                       // 0x005C(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               IsNeedSyncClient;                                         // 0x0060(0x0001) (ZeroConstructor, IsPlainOldData)
...
// ScriptStruct Basic.SkillTableRow
// 0x0108
struct FSkillTableRow
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FString                                     Name;                                                     // 0x0008(0x0010) (BlueprintVisible, ZeroConstructor)
	struct FString                                     IconPath;                                                 // 0x0018(0x0010) (BlueprintVisible, ZeroConstructor)
	int                                                SkillType;                                                // 0x0028(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Coeff1;                                                   // 0x002C(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CoolTime;                                                 // 0x0030(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
	struct FString                                     BPPath;                                                   // 0x0038(0x0010) (BlueprintVisible, ZeroConstructor)
	struct FString                                     Desc;                                                     // 0x0048(0x0010) (BlueprintVisible, ZeroConstructor)
	TArray<int>                                        BuffIDs;                                                  // 0x0058(0x0010) (BlueprintVisible, ZeroConstructor)
	TMap<int, int>                                     BuffLoadTypes;                                            // 0x0068(0x0050) (BlueprintVisible, ZeroConstructor)
	TMap<int, struct FMultiStringMap>                  Buffs;                                                    // 0x00B8(0x0050) (BlueprintVisible, ZeroConstructor)
};
...
struct FBuffTableRow
{
	...
	EBuffShowInUIType                                  NeedShowInUIType;                                         // 0x010F(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
