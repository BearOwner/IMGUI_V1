...
// Enum MovieScene.ESpawnUserQualitySettingLevel
enum class ESpawnUserQualitySettingLevel : uint8_t
{
	ESpawnUserQualitySettingLevel__UserQualitySettingLevel_Low = 0,
	ESpawnUserQualitySettingLevel__UserQualitySettingLevel_Middle = 1,
	ESpawnUserQualitySettingLevel__UserQualitySettingLevel_High = 2,
	ESpawnUserQualitySettingLevel__UserQualitySettingLevel_MAX = 3
};


// Enum MovieScene.ESpawnDeviceLevel
enum class ESpawnDeviceLevel : uint8_t
{
	ESpawnDeviceLevel__DeviceLevel_Low = 0,
	ESpawnDeviceLevel__DeviceLevel_Middle = 1,
	ESpawnDeviceLevel__DeviceLevel_High = 2,
	ESpawnDeviceLevel__DeviceLevel_MAX = 3
};
...
struct FMovieSceneSpawnable
{
	...
	ESpawnDeviceLevel                                  DeviceLevel;                                              // 0x0039(0x0001) (ZeroConstructor, IsPlainOldData)
	ESpawnUserQualitySettingLevel                      UserQualitySettingLevel;                                  // 0x003A(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnValidDeviceLevel;                                       // 0x003B(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	EMovieSceneCompletionMode                          CompletionMode;                                           // 0x0009(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x6];                                       // 0x000A(0x0006) MISSED OFFSET
	class UMovieSceneSection*                          SourceSection;                                            // 0x0010(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
};
