...
enum class ECustomAKAreaType : uint8_t
{
	...
	ECustomAKAreaType__EAT_ApartArea2 = 2,
	ECustomAKAreaType__EAT_TransitionArea = 3,
	ECustomAKAreaType__EAT_MAX     = 4
};
...
struct FAkCombinedInfo
{
	...
	bool                                               bIsUpdateEmmiterTransform;                                // 0x000D(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x000E(0x0002) MISSED OFFSET
	TArray<struct FString>                             EventList;                                                // 0x0010(0x0010) (ZeroConstructor)
	TMap<struct FString, float>                        RTPCList;                                                 // 0x0020(0x0050) (ZeroConstructor)
	TMap<struct FString, struct FString>               SwitchList;                                               // 0x0070(0x0050) (ZeroConstructor)
};
...
struct FAKErrorInfo
{
	...
	unsigned char                                      UnknownData01[0x50];                                      // 0x0001(0x0050) UNKNOWN PROPERTY: SetProperty AkAudio.AKErrorInfo.DetailInfo
};
