...
enum class EStatePlayerType : uint8_t
{
	...
	EStatePlayerType__EStatePlayerType_MAX = 10
};
...
struct FAIPlayerStateBaseMod : public FAIStateInfoBase
{
	...
	unsigned char                                      UnknownData11[0x4];                                       // 0x0134(0x0004) MISSED OFFSET
};
...
{
	struct FAIPlayerStateBaseMod                       State;                                                    // 0x0020(0x0138)
	struct FCameraState                                Camera;                                                   // 0x0158(0x0040)
	struct FAIPlayerWeapon                             Weapon;                                                   // 0x0198(0x0010)
	struct FAIPlayerBackpack                           BackPack;                                                 // 0x01A8(0x0010)
	struct FAIPlayerEquipment                          equipment;                                                // 0x01B8(0x0010)
	uint32_t                                           Key;                                                      // 0x01C8(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	struct FAIHeardSound                               Sound;                                                    // 0x0228(0x0010)
	struct FAIDamageSources                            damage_sources;                                           // 0x0238(0x0048)
	TArray<struct FDamageSource>                       all_damage_source;                                        // 0x0280(0x0010) (ZeroConstructor)
	struct FProgressBarState                           progress_bar;                                             // 0x0290(0x0028)
	TArray<struct FAINearbyPlayerBaseMod>              nearby_player;                                            // 0x02B8(0x0010) (ZeroConstructor)
	TArray<struct FItemStateData>                      nearby_item;                                              // 0x02C8(0x0010) (ZeroConstructor)
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x02D8(0x0010) (ZeroConstructor)
	struct FAIPlayerHitInfo                            player_hit_info;                                          // 0x02E8(0x0030)
	struct FAIBulletHoles                              bullet_holes;                                             // 0x0318(0x0038)
	TArray<struct FAIBulletHole>                       all_bullet_hole;                                          // 0x0350(0x0010) (ZeroConstructor)
	...
	struct FAIStateConfig                              Config;                                                   // 0x0368(0x0020)
	unsigned char                                      UnknownData02[0x28];                                      // 0x0388(0x0028) MISSED OFFSET
	TArray<uint64_t>                                   nearby_item_index;                                        // 0x03B0(0x0010) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_thrown_index;                                      // 0x03C0(0x0010) (ZeroConstructor)
	struct FDamageRateInfo                             damage_rate_info;                                         // 0x03D0(0x0040)
	TArray<struct FChatMsgInfo>                        chatmsg_info_list;                                        // 0x0410(0x0010) (ZeroConstructor)
	TArray<struct FSignMsgInfo>                        signmsg_info_list;                                        // 0x0420(0x0010) (ZeroConstructor)
	TArray<struct FMapMarkInfo>                        mapmark_info_list;                                        // 0x0430(0x0010) (ZeroConstructor)
	TArray<struct FAIAvatarInfo>                       avatar_info;                                              // 0x0440(0x0010) (ZeroConstructor)
	TArray<struct FAIDestroyBulletProbInfo>            destroy_bullet_prob_info;                                 // 0x0450(0x0010) (ZeroConstructor)
};
...
// 0x05B0 (0x05D0 - 0x0020)
struct FDiffAIStateInfoBaseModGeneral : public FDiffUniqueStateInfo
{
	struct FDiffAIPlayerStateBaseModGeneral            State;                                                    // 0x0020(0x0150)
	struct FAIHeardSound                               Sound;                                                    // 0x0170(0x0010)
	struct FAIDamageSources                            damage_sources;                                           // 0x0180(0x0048)
	struct FAIPlayerInteractInfo                       player_interact_info;                                     // 0x01C8(0x0058)
	struct FCameraState                                Camera;                                                   // 0x0220(0x0040)
	struct FDiffAIPlayerWeaponGeneral                  Weapon;                                                   // 0x0260(0x0050)
	struct FDiffAIPlayerBackpackGeneral                BackPack;                                                 // 0x02B0(0x0050)
	struct FDiffAIPlayerEquipmentGeneral               equipment;                                                // 0x0300(0x0050)
	struct FProgressBarState                           progress_bar;                                             // 0x0350(0x0028)
	struct FDiffAINearbyPlayersBaseModGeneral          nearby_player;                                            // 0x0378(0x0078)
	struct FDiffItemStateDatasGeneral                  nearby_item;                                              // 0x03F0(0x0038)
	TArray<uint64_t>                                   nearby_item_index;                                        // 0x0428(0x0010) (ZeroConstructor)
	struct FDiffAINearbyThrownGeneral                  nearby_thrown;                                            // 0x0438(0x0038)
	TArray<uint64_t>                                   nearby_thrown_index;                                      // 0x0470(0x0010) (ZeroConstructor)
	struct FAIPlayerHitInfo                            player_hit_info;                                          // 0x0480(0x0030)
	uint32_t                                           Key;                                                      // 0x04B0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x04B4(0x0004) MISSED OFFSET
	struct FAIBulletHoles                              bullet_holes;                                             // 0x04B8(0x0038)
	uint32_t                                           ai_style;                                                 // 0x04F0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x04F4(0x0004) MISSED OFFSET
	struct FAIStateConfig                              Config;                                                   // 0x04F8(0x0020)
	struct FDamageRateInfo                             damage_rate_info;                                         // 0x0518(0x0040)
	TArray<struct FChatMsgInfo>                        chatmsg_info_list;                                        // 0x0558(0x0010) (ZeroConstructor)
	TArray<struct FSignMsgInfo>                        signmsg_info_list;                                        // 0x0568(0x0010) (ZeroConstructor)
	TArray<struct FMapMarkInfo>                        mapmark_info_list;                                        // 0x0578(0x0010) (ZeroConstructor)
	TArray<struct FAIAvatarInfo>                       avatar_info;                                              // 0x0588(0x0010) (ZeroConstructor)
	struct FDiffAIDestroyBulletProbInfoListGeneral     destroy_bullet_prob_info;                                 // 0x0598(0x0038)
};
...
struct FDiffAIPlayerStateBaseMod : public FDiffStateInfoBase
{
	...
	unsigned char                                      UnknownData10[0x7];                                       // 0x0109(0x0007) MISSED OFFSET
};
...
struct FAIPlayerStateBRBase : public FAIStateInfoBase
{
	...
	bool                                               can_self_revival;                                         // 0x0048(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0049(0x0003) MISSED OFFSET
	uint32_t                                           leader_id;                                                // 0x004C(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           parachute_type;                                           // 0x0050(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                expect_delivery_num;                                      // 0x0054(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                remain_delivery_num;                                      // 0x0058(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAIStateXYZ                                 target_position;                                          // 0x005C(0x000C)
};
...
struct FDynamicItem : public FUniqueStateInfo
{
	...
	int                                                parallel_world_id;                                        // 0x0048(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x004C(0x0004) MISSED OFFSET
};
...
struct FDiffAIStateInfoBRBase : public FDiffStateInfoBase
{
	...
	struct FDiffVehicleState                           vehicle_state;                                            // 0x0078(0x00A0)
	TArray<struct FDoorState>                          nearby_door;                                              // 0x0118(0x0010) (ZeroConstructor)
	struct FDiffVehicleStates                          nearby_vehicles;                                          // 0x0128(0x0038)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x0160(0x0010) (ZeroConstructor)
	struct FDiffMonsterStates                          monster_states;                                           // 0x0170(0x0038)
	struct FDiffDynamicItemStates                      dynamic_item_states;                                      // 0x01A8(0x0038)
	struct FDiffLandScapeDestroyStateInfo              landscape_destroy_info;                                   // 0x01E0(0x0038)
};
...
{
	struct FAIPlayerStateBaseMod                       State;                                                    // 0x0020(0x0138)
	struct FAIPlayerInteractInfo                       player_interact_info;                                     // 0x0158(0x0058)
	struct FCameraState                                Camera;                                                   // 0x01B0(0x0040)
	struct FAIPlayerWeapon                             Weapon;                                                   // 0x01F0(0x0010)
	struct FAIPlayerBackpack                           BackPack;                                                 // 0x0200(0x0010)
	struct FAIPlayerEquipment                          equipment;                                                // 0x0210(0x0010)
	uint32_t                                           Key;                                                      // 0x0220(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           ai_style;                                                 // 0x0224(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FChatMsgInfo>                        chatmsg_info_list;                                        // 0x0228(0x0010) (ZeroConstructor)
	TArray<struct FSignMsgInfo>                        signmsg_info_list;                                        // 0x0238(0x0010) (ZeroConstructor)
	TArray<struct FMapMarkInfo>                        mapmark_info_list;                                        // 0x0248(0x0010) (ZeroConstructor)
	TArray<struct FAIAvatarInfo>                       avatar_info;                                              // 0x0258(0x0010) (ZeroConstructor)
...
{
	struct FDiffAIPlayerStateBaseModGeneral            State;                                                    // 0x0020(0x0150)
	struct FAIPlayerInteractInfo                       player_interact_info;                                     // 0x0170(0x0058)
	struct FCameraState                                Camera;                                                   // 0x01C8(0x0040)
	struct FDiffAIPlayerWeaponGeneral                  Weapon;                                                   // 0x0208(0x0050)
	struct FDiffAIPlayerBackpackGeneral                BackPack;                                                 // 0x0258(0x0050)
	struct FDiffAIPlayerEquipmentGeneral               equipment;                                                // 0x02A8(0x0050)
	uint32_t                                           Key;                                                      // 0x02F8(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           ai_style;                                                 // 0x02FC(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FChatMsgInfo>                        chatmsg_info_list;                                        // 0x0300(0x0010) (ZeroConstructor)
	TArray<struct FSignMsgInfo>                        signmsg_info_list;                                        // 0x0310(0x0010) (ZeroConstructor)
	TArray<struct FMapMarkInfo>                        mapmark_info_list;                                        // 0x0320(0x0010) (ZeroConstructor)
	TArray<struct FAIAvatarInfo>                       avatar_info;                                              // 0x0330(0x0010) (ZeroConstructor)
};
...
struct FAIPlayerBRBaseState : public FAIStateInfoBase
{
	...
	struct FAIStateXYZ                                 target_position;                                          // 0x0054(0x000C)
};
...
struct FGlobalGameBRBaseState : public FAIStateInfoBase
{
	...
	TArray<uint32_t>                                   silent_list;                                              // 0x00E8(0x0010) (ZeroConstructor)
};
...
struct FDiffGlobalGameBRBaseState : public FAIStateInfoBase
{
	...
	struct FDiffRedZoneState                           red_zone;                                                 // 0x0088(0x0030)
	struct FDiffSafetyAreaState                        safety_area;                                              // 0x00B8(0x0048)
	struct FDiffPlaneInfo                              airplane_list;                                            // 0x0100(0x0038)
	TArray<uint32_t>                                   silent_list;                                              // 0x0138(0x0010) (ZeroConstructor)
};
...
struct FDiffAllPlayerBRBaseInfo : public FAIStateInfoBase
{
	...
	struct FGlobalGameBRBaseState                      global_state;                                             // 0x00B8(0x00F8)
	struct FDiffGlobalGameBRBaseState                  diff_global_state;                                        // 0x01B0(0x0148)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          global_player_states;                                     // 0x02F8(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIBRBaseStateInfo>      global_player_diff_states;                                // 0x0348(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          near_player_states;                                       // 0x0398(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIBRBaseStateInfo>      near_player_diff_states;                                  // 0x03E8(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          global_btai_states;                                       // 0x0438(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIBRBaseStateInfo>      global_btai_diff_states;                                  // 0x0488(0x0050) (ZeroConstructor)
};
...
struct FDiffGlobalGameBRBaseStateGeneral : public FAIStateInfoBase
{
	...
	struct FDiffPlaneInfoGeneral                       airplane_list;                                            // 0x0100(0x0038)
...
struct FGlobalGameStateBRBase : public FAIStateInfoBase
{
	...
	struct FSafetyAreaState                            safety_area;                                              // 0x0068(0x0048)
	TArray<struct FPlaneInfo>                          airplane_list;                                            // 0x00B0(0x0010) (ZeroConstructor)
	struct FGlobalNearbyInfoBRBase                     global_nearby_info;                                       // 0x00C0(0x0058)
	struct FGlobalControlInfo                          control_info;                                             // 0x0118(0x0020)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0138(0x0008) MISSED OFFSET
	TArray<struct FAIStateXYZ>                         vehicle_spot_position;                                    // 0x0140(0x0010) (ZeroConstructor)
	TArray<struct FLandScapeChangeState>               landscape_change_info;                                    // 0x0150(0x0010) (ZeroConstructor)
	TArray<uint32_t>                                   silent_list;                                              // 0x0160(0x0010) (ZeroConstructor)
};
...
struct FDiffGlobalGameStateBRBaseGeneral : public FAIStateInfoBase
{
	...
	struct FSafetyAreaState                            safety_area;                                              // 0x00B8(0x0048)
	struct FDiffPlaneInfoGeneral                       airplane_list;                                            // 0x0100(0x0038)
	struct FDiffGlobalNearbyInfoBRBaseGeneral          global_nearby_info;                                       // 0x0138(0x00F8)
	struct FGlobalControlInfo                          control_info;                                             // 0x0230(0x0020)
	TArray<struct FAIStateXYZ>                         vehicle_spot_position;                                    // 0x0250(0x0010) (ZeroConstructor)
	struct FDiffLandScapeChangeStateGeneral            landscape_change_info;                                    // 0x0260(0x0038)
	TArray<uint32_t>                                   silent_list;                                              // 0x0298(0x0010) (ZeroConstructor)
};
...
struct FDiffAllPlayerInfoBRBase : public FAIStateInfoBase
{
	...
	struct FGlobalGameStateBRBase                      global_state;                                             // 0x0038(0x0170)
	struct FDiffGlobalGameStateBRBase                  diff_global_state;                                        // 0x01A8(0x0148)
	TArray<struct FAIStateInfoBRBase>                  global_player_states;                                     // 0x02F0(0x0010) (ZeroConstructor)
	TArray<struct FDiffBTAIAndPlayerStateInfoBRBase>   global_player_diff_states;                                // 0x0300(0x0010) (ZeroConstructor)
	TArray<struct FAIStateInfoBRBase>                  near_player_states;                                       // 0x0310(0x0010) (ZeroConstructor)
	TArray<struct FDiffBTAIAndPlayerStateInfoBRBase>   near_player_diff_states;                                  // 0x0320(0x0010) (ZeroConstructor)
	TArray<struct FAIStateInfoBRBase>                  global_btai_states;                                       // 0x0330(0x0010) (ZeroConstructor)
	TArray<struct FDiffBTAIAndPlayerStateInfoBRBase>   global_btai_diff_states;                                  // 0x0340(0x0010) (ZeroConstructor)
};
...
struct FDiffAIVehicleStateInfo : public FUniqueStateInfo
{
	...
	struct FDiffVehicleState                           vehicle_state;                                            // 0x0040(0x00A0)
	struct FDiffVehicleStates                          nearby_vehicles;                                          // 0x00E0(0x0038)
};
