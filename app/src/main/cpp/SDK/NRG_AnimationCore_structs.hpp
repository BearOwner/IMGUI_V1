...
{
	struct FAxis                                       LookAt_Axis;                                              // 0x000C(0x0010) (Edit)
	struct FAxis                                       LookUp_Axis;                                              // 0x001C(0x0010) (Edit)
	bool                                               bUseLookUp;                                               // 0x002C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
	ETransformConstraintType                           TransformType;                                            // 0x000B(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
