...
public:
	...
	unsigned char                                      bWriteSceneZBufferNew : 1;                                // 0x00B4(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	...
	TEnumAsByte<enum EMouseCursor>                     Cursor;                                                   // 0x00B7(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bEnableLazyLoad : 1;                                      // 0x01EC(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01 : 1;                                        // 0x01EC(0x0001)
	unsigned char                                      bCookedWidgetTree : 1;                                    // 0x01ED(0x0001)
	bool                                               needAutoPlay;                                             // 0x01EE(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               isAutoLoop;                                               // 0x01EF(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData03[0x50];                                      // 0x0210(0x0050) MISSED OFFSET
	...
	void PlayUserWidgetAnimation(class UWidgetAnimation* InAnimation, float StartAtTime, int NumLoopsToPlay, TEnumAsByte<enum EUMGSequencePlayMode> PlayMode, float PlaybackSpeed);
	...
	class UWidget* GetOrCreateLazyChild(const struct FString& Name);
	bool GetIsVisible();
...
public:
	...
	TEnumAsByte<enum EOrientation>                     Orientation;                                              // 0x0A90(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bDisableHorOrVertMove;                                    // 0x0AA9(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bDisableScroll;                                           // 0x0AAA(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bDontPaintWhenChildEmpty;                                 // 0x0AAB(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UClass*                                      ContentClass;                                             // 0x0038(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class UClass*                                      WidgetClass;                                              // 0x08A0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   DrawSize;                                                 // 0x08A8(0x0008) (Edit, IsPlainOldData)
	bool                                               bManuallyRedraw;                                          // 0x08B0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRedrawRequested;                                         // 0x08B1(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x08B2(0x0002) MISSED OFFSET
	float                                              RedrawTime;                                               // 0x08B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x08B8(0x0008) MISSED OFFSET
	struct FIntPoint                                   CurrentDrawSize;                                          // 0x08C0(0x0008) (IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x08C8(0x0004) MISSED OFFSET
	bool                                               bDrawAtDesiredSize;                                       // 0x08CC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x08CD(0x0003) MISSED OFFSET
	struct FVector2D                                   Pivot;                                                    // 0x08D0(0x0008) (Edit, IsPlainOldData)
	bool                                               bReceiveHardwareInput;                                    // 0x08D8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bWindowFocusable;                                         // 0x08D9(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x6];                                       // 0x08DA(0x0006) MISSED OFFSET
	class ULocalPlayer*                                OwnerPlayer;                                              // 0x08E0(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x08E8(0x0010) (Edit, IsPlainOldData)
	struct FLinearColor                                TintColorAndOpacity;                                      // 0x08F8(0x0010) (Edit, IsPlainOldData)
	float                                              OpacityFromTexture;                                       // 0x0908(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EWidgetBlendMode                                   BlendMode;                                                // 0x090C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTwoSided;                                              // 0x090D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               TickWhenOffscreen;                                        // 0x090E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x1];                                       // 0x090F(0x0001) MISSED OFFSET
	class UUserWidget*                                 Widget;                                                   // 0x0910(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData06[0x20];                                      // 0x0918(0x0020) MISSED OFFSET
	class UBodySetup*                                  BodySetup;                                                // 0x0938(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterialAA;                                    // 0x0940(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterialAA_OneSided;                           // 0x0948(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial;                                      // 0x0950(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial_OneSided;                             // 0x0958(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial;                                           // 0x0960(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial_OneSided;                                  // 0x0968(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial;                                           // 0x0970(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial_OneSided;                                  // 0x0978(0x0008) (ZeroConstructor, IsPlainOldData)
	class UTextureRenderTarget2D*                      RenderTarget;                                             // 0x0980(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInstanceDynamic*                    MaterialInstance;                                         // 0x0988(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bAddedToScreen;                                           // 0x0990(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bEditTimeUsable;                                          // 0x0991(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x6];                                       // 0x0992(0x0006) MISSED OFFSET
	struct FName                                       SharedLayerName;                                          // 0x0998(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LayerZOrder;                                              // 0x09A0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EWidgetGeometryMode                                GeometryMode;                                             // 0x09A4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x09A5(0x0003) MISSED OFFSET
	float                                              CylinderArcAngle;                                         // 0x09A8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x54];                                      // 0x09AC(0x0054) MISSED OFFSET
	bool                                               ForceDisableShareRT;                                      // 0x0A00(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0xF];                                       // 0x0A01(0x000F) MISSED OFFSET
...
public:
	...
	TEnumAsByte<enum EOrientation>                     Orientation;                                              // 0x0408(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               bAutoScrollText;                                          // 0x0128(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0129(0x0003) MISSED OFFSET
	float                                              ScrollSpeed;                                              // 0x012C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EAutoScrollType                                    AutoScrollType;                                           // 0x0130(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0131(0x0007) MISSED OFFSET
	struct FEditableTextBoxStyle                       WidgetStyle;                                              // 0x0138(0x0A68) (Edit, BlueprintVisible)
	class USlateWidgetStyleAsset*                      Style;                                                    // 0x0BA0(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FText                                       HintText;                                                 // 0x0BA8(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x0BC0(0x0010) (ZeroConstructor, InstancedReference)
	struct FSlateFontInfo                              Font;                                                     // 0x0BD0(0x0058) (Deprecated)
	struct FLinearColor                                ForegroundColor;                                          // 0x0C28(0x0010) (Deprecated, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x0C38(0x0010) (Deprecated, IsPlainOldData)
	struct FLinearColor                                ReadOnlyForegroundColor;                                  // 0x0C48(0x0010) (Deprecated, IsPlainOldData)
	bool                                               IsReadOnly;                                               // 0x0C58(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               IsPassword;                                               // 0x0C59(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0C5A(0x0002) MISSED OFFSET
	float                                              MinimumDesiredWidth;                                      // 0x0C5C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FMargin                                     Padding;                                                  // 0x0C60(0x0010) (Deprecated, IsPlainOldData)
	bool                                               IsCaretMovedWhenGainFocus;                                // 0x0C70(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               SelectAllTextWhenFocused;                                 // 0x0C71(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               RevertTextOnEscape;                                       // 0x0C72(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               ClearKeyboardFocusOnCommit;                               // 0x0C73(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               SelectAllTextOnCommit;                                    // 0x0C74(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               AllowContextMenu;                                         // 0x0C75(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EVirtualKeyboardType>             KeyboardType;                                             // 0x0C76(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x0C77(0x0001) MISSED OFFSET
	struct FShapedTextOptions                          ShapedTextOptions;                                        // 0x0C78(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly)
	bool                                               bVirtualKeyboardTriggerDirect;                            // 0x0C7C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0C7D(0x0003) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnTextChanged;                                            // 0x0C80(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTextCommitted;                                          // 0x0C90(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData05[0x10];                                      // 0x0CA0(0x0010) MISSED OFFSET
...
public:
	...
	EButtonClickGroupEnum                              ButtonClickGroupName;                                     // 0x0518(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               MatchSize;                                                // 0x01C8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FString                                     imageSrcPath;                                             // 0x0200(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FVector2D                                   ScalePivot;                                               // 0x0210(0x0008) (Edit, IsPlainOldData)
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x0218(0x0010) (Edit, ZeroConstructor, InstancedReference)
	struct FSoftObjectPath                             AsyncLoadResourcePath;                                    // 0x0228(0x0018)
	unsigned char                                      UnknownData01[0x20];                                      // 0x0240(0x0020) MISSED OFFSET
	float                                              HitTestAreaRadius;                                        // 0x0260(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsEnhancedImage;                                         // 0x0264(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsUseEnhancedHitTest;                                    // 0x0265(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bFixOverScale;                                            // 0x0266(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bVersionImg;                                              // 0x0267(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDontPaintWhenAlphaZero;                                  // 0x0268(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDontPaintWhenColorZero;                                  // 0x0269(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAsyncLoadImageAsset;                                     // 0x026A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDisablePixelSnapping;                                    // 0x026B(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	void SetColorAndOpacity(const struct FLinearColor& InColorAndOpacity);
	void SetBrushResourceFromPathSync(const struct FString& ResourcePath, bool bMatchSize);
...
public:
	...
	TEnumAsByte<enum EHorizontalAlignment>             HorizontalAlignment;                                      // 0x0124(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EVerticalAlignment>               VerticalAlignment;                                        // 0x0125(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	TEnumAsByte<enum EBlurType>                        BlurType;                                                 // 0x012D(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FMargin                                     Padding;                                                  // 0x0040(0x0010) (Edit, IsPlainOldData)
	TEnumAsByte<enum EHorizontalAlignment>             HorizontalAlignment;                                      // 0x0050(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EVerticalAlignment>               VerticalAlignment;                                        // 0x0051(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum EHorizontalAlignment>             HorizontalAlignment;                                      // 0x0050(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EVerticalAlignment>               VerticalAlignment;                                        // 0x0051(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x16];                                      // 0x0052(0x0016) MISSED OFFSET
...
public:
	...
	bool                                               bSupportNotch;                                            // 0x0069(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum EHorizontalAlignment>             HorizontalAlignment;                                      // 0x08A8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum EVirtualKeyboardType>             KeyboardType;                                             // 0x04AE(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bVirtualKeyboardTriggerDirect;                            // 0x04B4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum EHorizontalAlignment>             HorizontalAlignment;                                      // 0x0058(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EVerticalAlignment>               VerticalAlignment;                                        // 0x0059(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum ESelectionMode>                   SelectionMode;                                            // 0x0118(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum EMenuPlacement>                   Placement;                                                // 0x0130(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum ETextJustify>                     Justification;                                            // 0x0104(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ETextVerticalJustify>             VerticalJustification;                                    // 0x0105(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum EProgressBarFillType>             BarFillType;                                              // 0x0354(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FMargin                                     SafeAreaScale;                                            // 0x0044(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	TEnumAsByte<enum EHorizontalAlignment>             HAlign;                                                   // 0x0054(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EVerticalAlignment>               VAlign;                                                   // 0x0055(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0056(0x0002) MISSED OFFSET
	struct FMargin                                     Padding;                                                  // 0x0058(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
...
public:
	...
	bool                                               bFixQuivering;                                            // 0x011D(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bSingleLayoutPass;                                        // 0x011E(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x11];                                      // 0x011F(0x0011) MISSED OFFSET
...
public:
	...
	TEnumAsByte<enum EOrientation>                     Orientation;                                              // 0x0789(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	TMap<class UObject*, class UShareWidgetRT*>        SharedWidgetRTMap;                                        // 0x0448(0x0050) (ZeroConstructor)
...
public:
	...
	TEnumAsByte<enum ETextJustify>                     Justification;                                            // 0x0558(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	TEnumAsByte<enum EHorizontalAlignment>             HorizontalAlignment;                                      // 0x0040(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EVerticalAlignment>               VerticalAlignment;                                        // 0x0041(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FScriptMulticastDelegate                    OnHoveredWidgetChanged;                                   // 0x0340(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0350(0x0010) MISSED OFFSET
	int                                                VirtualUserIndex;                                         // 0x0360(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PointerIndex;                                             // 0x0364(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ECollisionChannel>                TraceChannel;                                             // 0x0368(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0369(0x0003) MISSED OFFSET
	float                                              InteractionDistance;                                      // 0x036C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EWidgetInteractionSource                           InteractionSource;                                        // 0x0370(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableHitTesting;                                        // 0x0371(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShowDebug;                                               // 0x0372(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0373(0x0001) MISSED OFFSET
	struct FLinearColor                                DebugColor;                                               // 0x0374(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7C];                                      // 0x0384(0x007C) MISSED OFFSET
	struct FHitResult                                  CustomHitResult;                                          // 0x0400(0x0088) (Transient, IsPlainOldData)
	struct FVector2D                                   LocalHitLocation;                                         // 0x0488(0x0008) (Transient, IsPlainOldData)
	struct FVector2D                                   LastLocalHitLocation;                                     // 0x0490(0x0008) (Transient, IsPlainOldData)
	class UWidgetComponent*                            HoveredWidgetComponent;                                   // 0x0498(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	struct FHitResult                                  LastHitResult;                                            // 0x04A0(0x0088) (Transient, IsPlainOldData)
	bool                                               bIsHoveredWidgetInteractable;                             // 0x0528(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bIsHoveredWidgetFocusable;                                // 0x0529(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bIsHoveredWidgetHitTestVisible;                           // 0x052A(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	static void SetOriginalViewPortSizeXY(int X, int Y);
	static void SetOriginalViewPortSize(const struct FIntPoint& Size);
...
public:
	...
	TArray<struct FLazyLoadBinding>                    LazyLoadBindings;                                         // 0x0040(0x0010) (ZeroConstructor)
