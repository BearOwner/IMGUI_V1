...
public:
	...
	struct FLuaNetSerialization                        LuaNetSerialization;                                      // 0x04A0(0x0050) (Net)
...
{
public:
	unsigned char                                      UnknownData00[0x58];                                      // 0x04A8(0x0058) MISSED OFFSET
	struct FLuaNetSerialization                        LuaNetSerialization;                                      // 0x0500(0x0050) (Net)
	struct FString                                     LuaFilePath;                                              // 0x0550(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	struct FLuaNetSerialization                        LuaNetSerialization;                                      // 0x0530(0x0050) (Net)
...
// 0x00B8 (0x0878 - 0x07C0)
class ALuaPlayerController : public APlayerController
{
public:
	unsigned char                                      UnknownData00[0x58];                                      // 0x07C0(0x0058) MISSED OFFSET
	struct FLuaNetSerialization                        LuaNetSerialization;                                      // 0x0818(0x0050) (Net)
	struct FString                                     LuaFilePath;                                              // 0x0868(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	struct FLuaNetSerialization                        LuaNetSerialization;                                      // 0x08E0(0x0050) (Net)
	struct FString                                     LuaFilePath;                                              // 0x0930(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
