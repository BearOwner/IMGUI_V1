...
{
	EBuildingViewType__EBVT_Invalid = 0,
	EBuildingViewType__EBVT_UseController = 1,
	EBuildingViewType__EBVT_UseCamera = 2,
	EBuildingViewType__EBVT_UseCharacter = 3,
	EBuildingViewType__EBVT_Max    = 4
};
...
// ScriptStruct BuildSystem.BuildingActorDSBuildCheckData
// 0x0018
struct FBuildingActorDSBuildCheckData
{
	struct FVector                                     BuilderOffset;                                            // 0x0000(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     BuildingActorOffset;                                      // 0x000C(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
};

// ScriptStruct BuildSystem.BuildingActorDSBuildCheck
// 0x0018
