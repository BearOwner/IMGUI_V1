...
public:
	...
	static void GetImagePixelSize(const struct FString& sPath, class UObject* __WorldContext, int* Width, int* Height);
	static void GetLobbyCorpsIcon(int IconID, class UObject* __WorldContext, class UTexture2D** Value);
	static void IsAsyncSetTexture(class UObject* __WorldContext, bool* IsAsync);
