...
public:
	...
	void PlayAdvertise();
	void OriginalShare(int InShareType, const struct FString& InMSDKChannelName, const struct FString& InTitle, const struct FString& InContent, const struct FString& InLink, const struct FString& InThumbPath, const struct FString& InImagePath, const struct FString& InExtraJson, const struct FString& InUser);
	...
	void BindWhatsApp(const struct FString& InExtraJson);
	void BindVK();
...
public:
	...
	bool                                               bNeedForceLoginForRelationChainError;                     // 0x00D0(0x0001) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	unsigned char                                      UnknownData11[0x7];                                       // 0x00D1(0x0007) MISSED OFFSET
	int64_t                                            lastTimeSetForceLoginForRelationChainError;               // 0x00D8(0x0008) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	struct FString                                     lastLoginArea;                                            // 0x00E0(0x0010) (Edit, ZeroConstructor, EditConst)
