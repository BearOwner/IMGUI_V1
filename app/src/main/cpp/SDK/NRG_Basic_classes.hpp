...
public:
	...
	int                                                iRegionActor;                                             // 0x0510(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bStaticAddNetworkActor;                                   // 0x0514(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      AutoDormancyType;                                         // 0x0515(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class APlayerController*                           OwningController;                                         // 0x0450(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               ExecuteImmediately;                                       // 0x0091(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               EndImmediately;                                           // 0x0092(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	TMap<class UObject*, int>                          InstancedNodeNameToMemoryMap;                             // 0x00F0(0x0050) (ZeroConstructor)
	int                                                InstancedNodesTotalSize;                                  // 0x0140(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	void OnTryGetParams(int CauseSkillID);
...
public:
	...
	void OnDestroy();
	void OnChangeNotify();
	struct FString GetStringValue(const struct FString& Key, int CauseSkillID, const struct FString& DefaultValue);
	int GetIntValue(const struct FString& Key, int CauseSkillID, int DefaultValue);
	float GetFloatValue(const struct FString& Key, int CauseSkillID, float DefaultValue);
};
...
public:
	...
	unsigned char                                      UnknownData03[0x128];                                     // 0x0298(0x0128) MISSED OFFSET
	...
	void UpdateClientBuff(struct FClientSyncBrief* Brief);
	bool RemoveBuffBySkill(int SkillID, int LayerCount, class AActor* Causer);
	...
	TArray<struct FBuffInstInfo> GetBuffInfoBySkillID(int SkillID);
...
public:
	...
	TMap<struct FString, class UClass*>                BuffClassMap;                                             // 0x0070(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x110];                                     // 0x00C0(0x0110) MISSED OFFSET
...
{
public:
	bool                                               EnableTickOptimization;                                   // 0x0118(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	ETickOptimizationAnimUROMode                       AnimUpdateRateOptimizationsMode;                          // 0x0119(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x6];                                       // 0x011A(0x0006) MISSED OFFSET
	TArray<float>                                      FramesSkippedScreenSizeThresholds;                        // 0x0120(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<int>                                        LODToFramesSkipped;                                       // 0x0130(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                NonRenderedFramesSkipped;                                 // 0x0140(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxFramesSkippedForInterpolation;                         // 0x0144(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bForceEnableAnimUpdateRateOptimizations;                  // 0x0148(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               EnableTickOptimization;                                   // 0x0360(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	ETickOptimizationDistanceMode                      DistanceMode;                                             // 0x0361(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bActorTickChange;                                         // 0x0381(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bComponentsTickControl;                                   // 0x0382(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bComponentsTickChange;                                    // 0x0383(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bForceExecuteFirstTick;                                   // 0x0384(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
// 0x0158 (0x0890 - 0x0738)
class UUAENetDriver : public UIpNetDriver
{
public:
	float                                              NetCullChangeTime;                                        // 0x0738(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableCollectNetStats;                                   // 0x073C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableResetNetStats;                                     // 0x073D(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x152];                                     // 0x073E(0x0152) MISSED OFFSET
