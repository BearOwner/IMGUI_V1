...
struct FBP_STRUCT_WeaponAttrBPTable_type
{
	...
	float                                              CheckWeaponSkillDuration_f_11_6111F9C073ADAB21228400A10010AD36;// 0x0060(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                WeaponSkillID_12_225B82C01AF0B81B520FC56F0A446294;        // 0x0064(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
